              ...
              <table>
                <tbody>
                  ...
                  <tr>
                    <td></td>
                    <td>
                      <input type="submit" onclick="startRequest('{{HOST}}','search_invite_0_email')" class="input-submit" value="查找好友">
                    </td>
                  </tr>
                </tbody>
              </table>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <input type="submit" onclick="startRequest('{{HOST}}','search_invite_0_msn')" class="input-submit" value="查找好友">
                    </td>
                  </tr>
                </tbody>
              </table>
...
<input type="hidden" value="" id="outer">
...
<input type="hidden" value="empty" id="antispamRst">
