<li class="clearfix" id="commonFriend_{{ID}}" onmouseover="Sizzle('a.shut-new',this)[0].style.display='block'" onmouseout="Sizzle('a.shut-new',this)[0].style.display='none'">
	<a class="shut-new x-to-hide" href="javascript:;" title="不再推荐此人" onclick="XN.app.pymk.remove('{{ID}}');logRcd({action:'RecShare_cancle', guest_id:{{ID}},type:'{{TYPE_VALUE}}'});return false;"></a>
