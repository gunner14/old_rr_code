...
top_srcdir='/data/software/ImageMagick-6.7.6-9'
top_builddir='/data/software/ImageMagick-6.7.6-9'

MAGICK_CODER_MODULE_PATH='/data/software/ImageMagick-6.7.6-9/coders'
MAGICK_CONFIGURE_SRC_PATH='/data/software/ImageMagick-6.7.6-9/config'
MAGICK_CONFIGURE_BUILD_PATH='/data/software/ImageMagick-6.7.6-9/config'
MAGICK_FILTER_MODULE_PATH='/data/software/ImageMagick-6.7.6-9/filters'
DIRSEP=':'
