#ifndef ARCH_BASE_THREAD_H__
#define ARCH_BASE_THREAD_H__
...
extern "C" void* xce_detail_posix_thread_function(void* arg);  
...
private:
  friend void* xce_detail_posix_thread_function(void* arg);
...
inline void* xce_detail_posix_thread_function(void* arg)
{
...
int thread::start_thread(Function f, size_t stack_size) {
  ...
  error = ::pthread_create(&thread_, 0,
          xce_detail_posix_thread_function, arg.get());
  if (0 != error)
  	return error;
