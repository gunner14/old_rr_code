...
Mat FindMatInFile (const char sFile[],  // in
                   ...
                   unsigned Mask1)      // in
{
char       sFile1[SLEN]; // the mat file name
char       sImageDirs[SLEN];
vec_Mat    MatV;         // the matrices read in from the file
vec_string Tags;         // the tags (i.e. string before each mat in the file)
vec_int    TagInts;      // hex number at start of each of above tags
