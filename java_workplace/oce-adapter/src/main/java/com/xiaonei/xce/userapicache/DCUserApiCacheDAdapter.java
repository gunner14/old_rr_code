...
public final class DCUserApiCacheDAdapter extends Thread implements UserApiCacheInvoker {
	...
	private DistCacheAdapter getAdapter()
	{
		if( _adapter == null )
		{
			synchronized( this )
			{
				if( _adapter == null )
				{
					_adapter = DistCacheAdapter.connect("UserApiCacheD");
					return _adapter;
				}
			}
		}
