...
public class XFeedDispatcherMCAdapter extends AbstractModProxyHolder<Integer, XFeedDispatcherPrx>  {
	private static XFeedDispatcherMCAdapter instance;
...
//	}
	 ...
	 * 
	 */
	public static XFeedDispatcherMCAdapter getInstance() {
		if (instance == null) {
			instance = new XFeedDispatcherMCAdapter();
		}
		return instance;
	}
	
	private XFeedDispatcherMCAdapter() {
...
//		}
	...
	public void addOthersNewsFeed(int feedOwner, int target){
//		try {
//			getXFeedDispatcherOneway(target).deliverSupply(feedOwner, target);			
//		} catch (Exception e) {
//			Oce.getLogger().error(this.getClass().getName() + " " + e);
//		}
	}
