...
public class Actived extends AbcStrategy{
	 public Ret doStrategy(Source guester,Source source) {
		    Status visiter = (Status)guester ;
	    	return RoleImpl.getInstance().isActived(visiter)==true?Strategy.RET_CONTINUE:new Ret(false,false,this.getClassName()) ;
