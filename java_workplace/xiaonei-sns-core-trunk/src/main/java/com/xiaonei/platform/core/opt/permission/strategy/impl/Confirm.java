...
public class Confirm extends AbcStrategy {

	public Ret doStrategy(Source guester, Source source) {
		Status visiter = (Status)guester ;
		return RoleImpl.getInstance().isConfirm(visiter)==true?new Ret(false,false,this.getClassName()):Strategy.RET_CONTINUE ;
