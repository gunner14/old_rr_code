/**
 * $Id: WUserStageFactory.java 15433 2010-01-20 07:19:05Z yan.liu@XIAONEI.OPI.COM $
 ...
 * @since 2010-1-20
 */
public class WUserStageFactory implements UserStageFactory<UserStage> {

    @Override
    public UserStage create() {
