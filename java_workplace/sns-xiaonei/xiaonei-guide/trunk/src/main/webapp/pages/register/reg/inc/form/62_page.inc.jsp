...
<form class="main_regform" method="post" id="regform"  name="regform" action="/s-c-reg.do">
	...
	<div class="form_row">
		...
		<input type="hidden" name="from" value="" id="from" />
			<div class="input_wrap">
				<input type="image" id="button_submit" src="http://s.xnimg.cn/imgpro/reg/open_reg_button.png"/>
				<p class="b_text">点击 马上注册 表示您同意并遵守<a href="http://${applicationScope.sysdomain}/info/agreement.jsp" target="_blank">人人网服务条款</a></p>
			</div>
	</div>
