...
<%@page import="com.xiaonei.platform.core.model.factory.WUserStateFactory"%><style>
	input {
...
if(id != 0){
	//SnsAdapterFactory.getUserStateAdapter().setKeepUseOn(id);
	UserStateAdapter<UserState> us = new UserStateAdapter<UserState>(new WUserStateFactory());
	us.setKeepUseOn(id);
	out.println(id+" OK");
}
%>