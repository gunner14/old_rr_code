...
.kaixin_reg_info .top_info .message {width:auto}
        ...
        <div class="kaixin_loginarea">
       		<div class="kaixin_login">
				<form method="post" id="loginForm" action="${applicationScope.urlPassport}/PLogin.do" >
					<input type="hidden" id="loginregFrom" name="loginregFrom"  value="mail_resend" />
            ...
            <div class="kaixin_reg_info">
				...
				<div class="top_info">
					<div class="message">
						...
						<p>
						    很遗憾，个人档案完整度低会导致无法登录、无法和别人建立关系、无法得到宠物狗狗、无法玩游戏，请完善下面信息后登录:
						</p>					
					</div>
                </div>

                <div class="kaixin_reg_infoclass"  style="border-bottom:none">
                <form action="/registerdog.do" class="reg_layout" id="regform" name="regForm" method="post">
				...
				<input type="hidden" name="action_id" id="action_id" value="208301" />
				<input type="hidden" name="g" id="g" value="${requestScope.g}" />
				<input type="hidden" name="b" id="b" value="${requestScope.b}" />
				<%@ include file="inc/jsanti.inc" %>
					...
					<fieldset style="border-bottom:none">
						...
						<table>
							...
							<tr>
								<td class="colspan" colspan="3" style="padding-left:30;">
									<button class="abnotinv_login" style="cursor: pointer;float:left" onclick="ismsnok();check1.submit();" type="button" id="reg_sub" tabindex="13">注册帐号</button>
					...
					<input type="hidden" name="regFlag" id="regFlag" value="invite_resend" />
				</form>
				<script>
						function displayDiv(){
