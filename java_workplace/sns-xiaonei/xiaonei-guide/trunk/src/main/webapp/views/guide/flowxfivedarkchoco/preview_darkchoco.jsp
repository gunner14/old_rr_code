...
<body id="home" class="guide">
    ...
    <div class="user-data clearfix">
        <div class="title titleimg">
            <h1><strong>把你认识的人加为好友，随时获得好友动态。</strong></h1>
        </div><!--title end-->
...
<img width="0" height="0" src="http://guide.${domainIdentified["sys.domain"]}/xtrs?nur=rggp2v4a0<%= (new java.util.Random()).nextFloat()%>"/>
</body>
</html>
