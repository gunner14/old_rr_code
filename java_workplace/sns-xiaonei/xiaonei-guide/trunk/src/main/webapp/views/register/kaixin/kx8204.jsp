	...
	<div class="bg">
		<div class="wrapper clearfix">
			...
			<div class="body">
				...
				<input type="hidden" name="action_id" id="action_id" value="208204" />
					...
					<fieldset style="border-bottom:none">
						...
						<table style="width:80%">
							...
							<tr>
								<th></th>
								<td class="inputholder">
									<p class="float-left coder_input" style="line-height:24px;">
										<span class="required">&nbsp;&nbsp;</span>你是如何知道开心网的？
										<input type="text" name="recommend" id="sourcetext" title="最多20字" value="最多20字" maxlength="20" onfocus="this.style.color='#000';if(this.value==this.title){this.value='';}" onblur="if(this.value==''){this.value=this.title;this.style.color='#999'}else{this.style.color='#000'}"  tabindex="7" style="width:200px;height:22px;padding:5px 5px 0;"/>
									</p>									
								</td>
								<td>
									<div class="zc_cwts hide" id="icode_ok">&nbsp;<img src="${applicationScope.urlStatic}/kaixin/imgpro/reg/fzcg_dh.gif" /></div>
