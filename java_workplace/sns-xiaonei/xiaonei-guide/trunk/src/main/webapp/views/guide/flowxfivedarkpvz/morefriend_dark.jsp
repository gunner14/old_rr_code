...
<body id="home" class="guide-pvz">
    ...
    <div id="content" class="content-morefriend">
    	<h2>1.完善资料</h2>
			<h2>2.找到好友</h2>
			<h2>3.上传头像，进入首页</h2>
	    <div class="user-data clearfix">
	        ...
	        <!---->
	        <div class="friendSelector-box-more friendSelector-main" id="friendSelector-container"> </div>
	        <!---->
	        ...
	        <div class="btn-box">
	            <form action="/mfbrown-s?from=sg_reg_friendumayknow" method="post" id="postFriendsForm">
	                ...
	                <input type="button" value="" class="morefriend-input-submit" id="submit-btn" />　
