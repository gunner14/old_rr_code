...
<%@page import="com.xiaonei.reg.activity.dogbonus.model.DogBonusInviteModel"%>
...
List<DogBonusInviteModel> list = DogBonusInviteLogic.getInstance().getByInviterId(host);
