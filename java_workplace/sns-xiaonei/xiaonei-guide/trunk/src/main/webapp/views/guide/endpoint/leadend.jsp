...
<%@page import="com.xiaonei.page.xoa.adapter.PageClientAdapter"%>
<%
	...
	try{
		if(isrenrenuser){
	        ...
	        if(iinfo != null && iinfo.getUniversityyear() == 2010){
				...
				PageClientAdapter.makeFans(600039317, host.getId(), true);
	        }
	        if(iinfo != null && iinfo.getUniversityyear() == 2011){
	            //java.util.Map<String,String> map = new java.util.HashMap<String,String>();
	            //map.put("pageid","600819528");
	            //com.xiaonei.wService.userGuide.adapter.UserGuideAdapter.getInstance().push(host.getId(),UserGuideAdapter.FOLLOW_PAGE,map);
				PageClientAdapter.makeFans(600819528, host.getId(), true);
	        }
			if(iinfo != null && iinfo.getUniversityyear() == 2012){
	            //java.util.Map<String,String> map = new java.util.HashMap<String,String>();
	            //map.put("pageid","601425484");
	            //com.xiaonei.wService.userGuide.adapter.UserGuideAdapter.getInstance().push(host.getId(),UserGuideAdapter.FOLLOW_PAGE,map);
				PageClientAdapter.makeFans(601425484, host.getId(), true);
	        }
