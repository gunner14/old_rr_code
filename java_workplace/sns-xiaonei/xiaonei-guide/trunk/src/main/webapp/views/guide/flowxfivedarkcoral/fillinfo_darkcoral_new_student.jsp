...
<body>
	<script type="text/javascript">
		...
		var uid = ${requestScope._curUser.id};
	</script>
		...
		<div class="guide-main-new clearfix">
			...
			<div id="" class="guide-content clearfix">
				<div class="main-data clearfix">
					...
					<!-- 我上大学了 -->
					<form  id="univ_form" method="post" action="fillinfos-dx" style="display:none;">
							...
							<td class="schoolbox">
								...
								<p>
									...
									<select class="short select " id="univ_type" name="formDaxue.coursetype"  schema="univCourse">
										...
										<option value="大学生" selected="selected">大学生</option>
					...
					<!-- 我上中学 -->
					<form id="mid_form" method="post" action="fillinfos-zx" style="display:none;">
					...
					<!-- 我工作了 -->
					<form  id="work_form" method="post" action="fidarks-bl" style="display:none;">
					...
					<!-- 其他阶段 -->
					<form  id="none_form" method="post" action="fidarks-qt" style="display:none;" >
	...
	<script type="text/javascript">
		XN.dom.ready(function(){
			...
			Sizzle('#univ_year option[value=2012]')[0].setAttribute('selected','selected');
			Sizzle('#univ_high_year option[value=2009]')[0].setAttribute('selected','selected');
		});
