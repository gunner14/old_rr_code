...
.content{background:url(${applicationScope.urlStatic}/kaixin/imgpro/reg/dog8.jpg) no-repeat;height:800px;position:relative;}
       	...
       	<div class="content"> 
            ...
            <div class="kaixin_reg_info">
                ...
                <form action="/rgac.do" id="regform" name="regForm" method="post" class="reg_layout">
                	<input type="hidden" name="action_id" id="action_id" value="207109" />
