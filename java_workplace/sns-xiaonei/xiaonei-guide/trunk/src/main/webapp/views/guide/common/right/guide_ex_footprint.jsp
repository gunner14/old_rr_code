...
<%
	java.util.List<com.dodoyo.model.SnsFootprintView> visitList = (java.util.ArrayList<com.dodoyo.model.SnsFootprintView>)request.getAttribute("visitList");
...
<div class="side-item footprint with-arrow" id="footPrint">
	...
	<%
			for(com.dodoyo.model.SnsFootprintView view:visitList) {
				try {
	...
	%>
		...
		<a class="foot-forward foot-forward-disable" id="footForward" href="#" title="下一页" onclick="slideShow.getMore();return false;">下一页</a>
		<a class="foot-back foot-back-disable" id="footBack" href="#" title="" onclick="slideShow.getBack();return false;" style="cursor:default">上一页</a>
