...
<head><!-- _im_dark_ -->
    ...
    <link href="${applicationScope.urlSmallStatic}/csspro/module/school-selector.css?ver=$revxxx$" rel="stylesheet" type="text/css" media="all"></link>
    <link href="${applicationScope.urlSmallStatic}/csspro/apps/guide-register-pvz.css?ver=$revxxx$" rel="stylesheet" type="text/css" media="all"></link>
        ...
        <h1>通过MSN或邮箱寻找你已经在人人上的朋友们</h1>
            ...
            <dl>
	            <dt>
	                ...
	                <label class="msn" for="msn"><input type="radio" id="msn" name="emailmsn" <%="msnsend_form".equals(request.getAttribute("initform"))?"checked=\"true\"":""%>/> <img src="${applicationScope.urlStatic}/imgpro/guide/pvz/msn.png"/> MSN</label>
                </dt>
                <form target="loadingf" class="autoSubmit" subtn="add_friends" action="${applicationScope.urlInvite}/regGudDpt.do" id="msnsend_form" method="post" name="msnsend" style="display:block">
                    ...
                    <input type="hidden" name="pvz" value="pvz"/>
                    ...
                    <p class="form-action">
                     ...
                     -->
                     <div class="btn-box">
		                <input type="button" id="submit_msn" value="" class="search-input-submit" />
		                <img id="load_img_msn" class="loadingimg" src="${applicationScope.urlStatic}/img/indicator.gif" />
                ...
                <dd>MSN密码 : _不是这个<input type="text" class="input-text" id="" name=""/></dd>
                 ...
                 <form target="loadingf" class="autoSubmit" method="post" id="webmail" action="${applicationScope.urlInvite}/regGudDpt.do" >
                     ...
                     <div class="btn-box">
                         <input id="submit_email" class="search-input-submit" type="button" value=""/>
