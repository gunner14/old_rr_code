...
.content{background:url(${applicationScope.urlStatic}/kaixin/imgpro/reg/dog6.jpg) no-repeat;height:980px;position:relative;}
.kaixin_reg_info{float:right;margin-top:200px;margin-right:90px;width:500px;}
.form-tip{width:160px;}
.reg_layout{width:490px;margin:0;}
.login-top{position:absolute;top:75px;right:100px;}
...
.errors_div { margin-bottom:-15px;}
.reg_layout fieldset{*padding:0px 0 5px;}
.reg_layout th, .reg_layout td { padding:6px 3px;}
</style>
</head>
<body>
	<div class="mainbox">
    <div id="widebar">
       	<div class="content"> 
            ...
            <div class="kaixin_reg_info">
                ...
                <form action="/registerdog.do" id="regform" name="regForm" method="post" class="reg_layout" name="regForm">
					...
					<input type="hidden" name="action_id" id="action_id" value="207105" />
					<input type="hidden" name="g" id="g" value="${requestScope.g}" />
					<input type="hidden" name="b" id="b" value="${requestScope.b}" />
							...
							<table>
								...
								<tr>
									...
									<td class="inputholder"><span class="required">*</span>
										...
										<select
											property="homecitycode" id="homecitycode" class="select"
											tabindex="10"
						...
						<fieldset style="border-bottom:none">
							...
							<table>
								...
								<tr>
									...
									<button style="cursor: pointer;" type="button" id="reg_sub" onclick="ismsnok();check1.submit();" tabindex="13">我已填写完毕</button></td>
								</tr>
								<tr style="display:none">
								...
								<tr>
									<td colspan="3" class="colspan colspan_1">
										<div class="sharemsg_wrap">
											<a href="#" onclick="$('msnValid2').value='1';check1.submit();return false;" style="color:#808080;" class="microReg" id="reg_sub2" tabindex="14">使用微软认证</a>
											点击以上按钮，我们将认可您已阅读并同意遵守<a href="${applicationScope.urlMain}/info/agreement.jsp" target="_blank" tabindex="15">服务条款</a>。<br />
...
<c:if test="${requestScope.ss == '17001'}">
