...
<div class="tabs" id="search-tab">
	<c:choose>
		<c:when test="${visiter.stage==20}">
			...
			<a href="javascript:;" id="tab_nuniv" onclick="ajax_stat_link('more','guide_people_st');">大学同学</a><span class="pipe">|</span>
		...
		<c:when test="${visiter.stage==10}">
			<a href="javascript:;" id="tab_all" class="current" onclick="ajax_stat_link('more','guide_people_st');">全部</a><span class="pipe">|</span>
			<a href="javascript:;" id="tab_hs" onclick="ajax_stat_link('more','guide_people_st');">高中同学</a><span class="pipe">|</span>
		...
		<c:when test="${visiter.stage==30}">
			<a href="javascript:;" id="tab_all" class="current" onclick="ajax_stat_link('more','guide_people_st');">全部</a><span class="pipe">|</span>
			<a href="javascript:;" id="tab_worker" onclick="ajax_stat_link('more','guide_people_st');">同事</a><span class="pipe">|</span>
