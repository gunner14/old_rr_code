...
public class MyTimeCost {
	...
	private static void write(String msg, int type){
		if((null != map.get("STATUS")) && map.get("STATUS")==5){
...
//		String message = classname+"::"+method+"("+linenumber+"):"+msg;
    ...
    public static MyTimeCost begin(Object name) {
        return new MyTimeCost(String.valueOf(name));
    }

    public static MyTimeCost begin() {
        return new MyTimeCost();
    }

    private MyTimeCost(String name) {
