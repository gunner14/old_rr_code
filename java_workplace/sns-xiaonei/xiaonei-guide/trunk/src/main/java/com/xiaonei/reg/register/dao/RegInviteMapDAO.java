...
public class RegInviteMapDAO extends XnDAO {
    ...
    public int save(final RegInviteMap regInviteMapTable) throws SQLException {
        String sqlInsert = "insert into reg_invite_map (owner_id, inviter_id, inviter_group_name, app_id, time) values (?, ?, ?, ?, now())";
    ...
    public int getInviterId(final int ownerId) throws SQLException {
        String sqlGet = "select inviter_id from reg_invite_map where owner_id=?";
        OpUniq op = new OpUniq(sqlGet, DataAccessMgr.BIZ_STAT) {
    ...
    public String getInviterGroupName(final int ownerId) throws SQLException {
        String sqlGet = "select inviter_group_name from reg_invite_map where owner_id=?";
        OpUniq op = new OpUniq(sqlGet, DataAccessMgr.BIZ_STAT) {
    ...
    public RegInviteMap getByOwnerId(final int ownerId) throws SQLException {
        String sqlGet = "select * from reg_invite_map where owner_id = ?";
        OpUniq op = new OpUniq(sqlGet, DataAccessMgr.BIZ_STAT) {
