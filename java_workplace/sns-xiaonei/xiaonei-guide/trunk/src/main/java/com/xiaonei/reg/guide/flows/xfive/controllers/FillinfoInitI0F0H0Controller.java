 ...
 */
@LoginRequired
@Path({"i0f0h0fillinfo","fiblue"})
@IgnoreUserStatusImportedValidation
public class FillinfoInitI0F0H0Controller {
	...
	private static final String INIT_LEAD_ACE = "/views/guide/flowxfivedarkcoral/fillinfo_darkcoral_new_student.jsp"; //2012新生引导
	@Get
	@Post
			...
			try {
			  ...
			  //以下是往日志表里打信息
				...
				case IGuideUserLeadType.Lead_ACE:
					//StatLogger.info(host.getId(), ""+"type"+":"+type+""+" stage:"+host.getStage(),StatLogger.S_ARV_ENTERINTOO_FI_,StatLogger.TYPE_ACE);
					doInitStage(request,host);
					//doInitDatum(request,host);
					return INIT_LEAD_ACE;
