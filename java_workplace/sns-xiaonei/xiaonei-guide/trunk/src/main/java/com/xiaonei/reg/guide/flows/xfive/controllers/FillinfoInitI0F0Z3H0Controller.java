 ...
 */
@LoginRequired
@Path({ "i0f0z3h0fillinfo", "fiblue" })
@IgnoreUserStatusImportedValidation
public class FillinfoInitI0F0Z3H0Controller {
	...
	private static final String INIT_LEAD_AAA = "/views/guide/flowxfivedarkchoco/fillinfo_darkchoco.jsp"; // 通讯录
	...
	public String index(Invocation inv) {
		...
		if (request == null || response == null) {
			...
			try {
				...
				guideRecommendLogic.insertNewflowLogRecord(userid,host.getStage(), fromeSource + "_I0F0Z3H0", -1,"nooper");
				// 传IP
				try {
