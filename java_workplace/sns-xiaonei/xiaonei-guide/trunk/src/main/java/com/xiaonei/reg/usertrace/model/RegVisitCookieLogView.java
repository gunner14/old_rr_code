 ...
 */
public class RegVisitCookieLogView implements Serializable {
    ...
    public String getReg_cookie() {
        return reg_cookie;
    }

    public void setReg_cookie(String reg_cookie) {
        this.reg_cookie = reg_cookie;
    }
