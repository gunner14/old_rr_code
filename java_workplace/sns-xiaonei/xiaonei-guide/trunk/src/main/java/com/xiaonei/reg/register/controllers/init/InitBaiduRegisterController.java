...
/**
 * 		<action path="/initbaidureg" type="com.xiaonei.reg.register.action.init.InitBaiduRegisterAction" name="regForm" scope="request" >
 ...
 */
@Path("/initbaidureg.do")
public class InitBaiduRegisterController extends BaseRegController {
	...
	public RegForward executeRt(RegMapping mapping, RegForm form,
		...
		if (regForm.getFrom() != null && regForm.getFrom().equals("44")) {
			actionStr = String.valueOf(RegOprDefine.BAIDU44_REG_XN);
		}
	...
	protected Map<String, RegForward> setRegMapping(Map<String, RegForward> mapping) {
		// <forward name="success" path="/pages/register/reg/reg_6201.jsp" />
		mapping.put("success", new RegForward("/pages/register/reg/reg_6201.jsp"));
		return null;
	}
