		...
		<div class="main-page">
			<div class="home-content-holder clearfix">
				<div class="home-body">  
					...
					<%@ include file="/pages/register/guide_middle.jsp"%>
				...
				<div class="home-sidebar"> 
               		...
               		<%@ include file="/pages/guide/right/guide_hot_games.jsp" %>									
         			<%@ include file="/pages/register/guide_footprint.jsp" %><%--最近来访部分--%>  
         			<%@ include file="/pages/register/guide_right_pages.jsp" %> 
         			<%@ include file="/pages/guide/right/guide_my_pages.jsp" %>
         			<%--<%@ include file="/pages/register/guide_friend_contact.jsp" %>与好友取得联系--%>  
         			<%@ include file="/pages/guide/right/guide_my_friends.jsp" %>
         			<%@ include file="/pages/guide/right/guide_set_head.jsp" %>        				   										
					<%--<%@include file="/pages/register/guide_hs_leftGames.jsp" %>--%> 
                </div>              	
			</div>
		</div></div>
