...
<form class="main_regform" method="post" id="regform"  name="regform" action="/s-c-i-reg.do">
	<input type="hidden" name="fromUrl" id="fromUrl" />
	<input type="hidden" name="m" id="m" value="${requestScope.token}" />
	...
	<%@ include file="app_connect_reg.inc" %>
	...
	<div class="form_row" id="d_email">
		...
		<div class="input_wrap">
			<input type="hidden" name="regEmail" id="regEmail" class="inputtext"><strong style="vertical-align:middle; font-size:16px; float:left;">${regEmail}</strong></input>
			...
			<span id="dmmg"><img src="http://s.xnimg.cn/img/reg/fzcg_dh.gif"/></span>
			<span class="noqqalt" style="display:none">
