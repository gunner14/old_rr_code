...
#navigation .nav-right li a{color:#005EAC;text-decoration:none}
        ...
        <div class="kaixin_loginarea">
       		<div class="kaixin_login">
				<form method="post" id="loginForm" action="${applicationScope.urlPassport}/PLogin.do" >
					<input type="hidden" id="loginregFrom" name="loginregFrom"  value="normal_invite" />
                ...
                <label>帐号:</label>
						<input type="text" name="email" rule="blank#loginName" class="input-text" value="" id="email" tabindex="19" style="width:105px;"/>
					</div>
					<div class="login_textinput">
						<label>密码:</label>
						<input type="password" id="password" name="password" rule="blank" error="请输入密码" class="input-text" tabindex="20" style="width:105px;" />
					...
					<p class="logbtn">
						...
						<button type="submit" class="input-button low-padding" id="login" tabindex="21" />登录</button>&nbsp;&nbsp;<span class="dis-findpwd findpwd"><a href='${applicationScope.urlMain}/GetPasswd.do' tabindex="22">找回密码</a></span>
					</p>
				</form>
				</div>
            </div>
            <div class="kaixin_reg_info">
				...
				<input type="hidden" name="action_id" id="action_id" value="208101" />
				<input type="hidden" name="g" id="g" value="${requestScope.g}" />
				<input type="hidden" name="b" id="b" value="${requestScope.b}" />
					...
					<fieldset class="account-field">
						...
						<table>
							...
							<tr>
								...
								<td class="inputholder">
									<span class="required">*</span>
									<input type="password" name="repwd" class="input-text" id="repwd" tabindex="3" />
								</td>
								<td>
					...
					<fieldset>
						...
						<table>
							<tr>
								...
								<td class="inputholder">
									<span class="required">*</span>
									<input type="text" name="name" class="input-text" id="name" tabindex="4" />
								</td>
								<td>
							...
							<tr>
								...
								<td class="clearfix">
									<span class="required">*</span>
									<label for="male" class="reg_radio"><input type="radio" name="gender" value="男生"  tabindex="5"/>男</label>
									<label for="woman" class="reg_radio"><input type="radio" name="gender" value="女生"  tabindex="6"/>女</label>
								</td>
								<td>
							...
							<tr>
								...
								<td class="inputholder">
									<span class="required">*</span>
									<select name="birth_year" id="birth_year" style="width:55px;" tabindex="7">
									  <option value=""></option>
									...
									<select name="birth_month" id="birth_month" style="width:55px;" tabindex="8">
										<option value=""></option>
									...
									<select name="birth_day" id="birth_day" style="width:55px;" tabindex="9">
									    <option value=""></option>
										<option value="01">01</option>
										<option value="02">02</option>
										<option value="03">03</option>
							...
							<tr>
								...
								<td class="inputholder">
									...
									<select name="homeprovince"
										id="homeprovince" class="select" tabindex="10"
						...
						<table>
							<tr>
								...
								<td class="inputholder coder">
									<p class="float-left coder_input">
										<span class="required">*</span>
										<input type="text" name="icode" id="icode" size="5" maxlength="5" tabindex="12"/>&nbsp;&nbsp;
									</p>
									...
									%>
										...
										<a href="javascript:refreshCode();" onclick="javascript:void(0);" tabindex="13">看不清楚 换一张</a>
									</p>
								</td>
								<td>
							...
							<tr>
								<td colspan="3" class="colspan">
									<button id="reg_sub" type="button" onclick="ismsnok();check1.submit();" style="cursor:pointer;float:left" tabindex="14">接受好友请求</button>
									<a id="reg_sub2" class="microReg" style="color: rgb(128, 128, 128);line-height:34px" onclick="$('msnValid2').value='1';check1.submit();return false;" href="#" tabindex="15">使用微软认证</a>
								</td>
							</tr>
							...
							<tr style="display:none">
									<td class="colspan" colspan="2"><input type="checkbox" checked="checked" name="accept" id="accept" tabindex="16"/></td>
							...
							<tr>
								<td colspan="3" class="colspan">
									<input type="checkbox" checked="checked" name="sharemsg" id="sharemsg" value="ok" tabindex="17"/>
										你可以将这个消息分享给更多的msn好友<br/>点击以上按钮，我们将认可您已阅读并同意遵守 <a href="${applicationScope.urlMain}/info/agreement.jsp" target="_blank" tabindex="18">服务条款</a>
									<br>并可能出现您的 Windows Live Id 在此自动登陆的情况。</td>
							</tr>
							<tr style="display:none">
									<th></th>
									<td class="inputholder"><span class="required"></span>
										...
										<div style="display: none;" id="ismsn_ok" class="zc_cwts hide"> <img src="${applicationScope.urlStatic}/kaixin/imgpro/reg/fzcg_dh.gif"/></div>
										<div class="zc_cwts hide" id="ismsn_err"><img width="18" height="24" src="${applicationScope.urlStatic}/kaixin/imgpro/reg/th_ju.gif"/></div>
										</td>
									<td></td>
							</tr>
						</table>
					</fieldset>
					<input type="hidden" name="regFlag" id="regFlag" value="invite_reg" />
				</form>
