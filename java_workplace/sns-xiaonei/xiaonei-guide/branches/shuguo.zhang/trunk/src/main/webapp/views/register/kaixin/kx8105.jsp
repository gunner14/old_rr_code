        ...
        <div class="kaixin_loginarea">
       		<div class="kaixin_login">
				<form method="post" id="loginForm" action="${applicationScope.urlPassport}/PLogin.do" >
					<input type="hidden" id="loginregFrom" name="loginregFrom"  value="normal_step2" />
                ...
                <label>帐号:</label>
						<input type="text" name="email" rule="blank#loginName" class="input-text" value="" id="email" tabindex="17" style="width:105px;"/>
					</div>
					<div class="login_textinput">
						<label>密码:</label>
						<input type="password" id="password" name="password" rule="blank" error="请输入密码" class="input-text" tabindex="18" style="width:105px;" />
					...
					<p class="logbtn">
						...
						<button type="submit" class="input-button low-padding" id="login" tabindex="19" />登录</button>&nbsp;&nbsp;<span class="dis-findpwd findpwd"><a href='${applicationScope.urlMain}/GetPasswd.do' tabindex="20">找回密码</a></span>
					</p>
				</form>
				</div>
         </div>
            <div class="kaixin_reg_info">
                ...
                <div class="top_info">
					...
					<div class="message">
						...
						<div class="br">&nbsp;</div>
						<div class="btri">&nbsp;</div>
						<h2>完善你的个人信息，接受 ${requestScope.inviter.name} 的好友请求</h2>
                    	<p>${requestScope.inviter.name}请求成为你的好友，请在下面简单填写你的个人信息，接受 ${requestScope.inviter.name} 的请求</p>
				...
				<input type="hidden" name="action_id" id="action_id" value="208105" />
				<input type="hidden" name="g" id="g" value="${requestScope.g}" />
				<input type="hidden" name="b" id="b" value="${requestScope.b}" />
						...
						<table>
							...
							<tr>
								<td colspan="2" class="colspan">
									<input type="checkbox" id="accept" name="accept" checked="checked" tabindex="14" />我已阅读并同意遵守 <a href="${applicationScope.urlMain}/info/agreement.jsp" target="_blank" tabindex="15">开心网服务条款</a>
								</td>
								<td>
									<div id="accept_err" class="zc_cwts hide"><img height="24" width="18" src="${applicationScope.urlStatic}/kaixin/imgpro/reg/th_ju.gif"/></div>
								</td>
							</tr>
							<tr>
								<td colspan="3" class="colspan">
									<button id="reg_sub" type="submit" style="cursor:pointer;" tabindex="16">接受好友请求</button>
								</td>
							</tr>
