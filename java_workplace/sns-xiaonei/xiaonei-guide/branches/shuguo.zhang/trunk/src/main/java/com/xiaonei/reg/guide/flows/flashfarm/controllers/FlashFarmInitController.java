package com.xiaonei.reg.guide.flows.flashfarm.controllers;
...
/**
 * FlashFarmInitController.java
 * @author inshion(xin.yin@opi-corp.com)
 *
 * @date 2010-8-24 兼容老的af.do
 */
@LoginRequired
@Path({"fiff","af.do"})
public class FlashFarmInitController {
	private static final String SUCC = "/views/guide/flowflashfarm/flashfarm.jsp";
