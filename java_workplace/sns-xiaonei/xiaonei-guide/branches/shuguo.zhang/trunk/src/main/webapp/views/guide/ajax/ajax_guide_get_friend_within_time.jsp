...
try{
	...
	int blogCount=(Integer)request.getAttribute("blogCountkk");
	int doingCount=(Integer)request.getAttribute("doingCountkku");
	long doingId=(Long)request.getAttribute("doingId");
