...
<head><!-- _pv_darkcyan_ -->
	...
	<title>${domainIdentified["siteName_fillinfo"]} - 接受好友申请成功</title>
	<style type="text/css">
...
<body id="home" class="guide">
        ...
        <%
        //fof puk cls pfl
        String f_flag = "fof:"+request.getAttribute("lead_preview_inviterfriend_count");
        ...
        if(cluster_n != null && (Integer)cluster_n > 0){
        	...
        	request.setAttribute("lead_preview_inviterfriend",cluster_string);
        	f_flag = "cls:"+cluster_n;
        }
        else{
        	Object inviterfriend_o = request.getAttribute("lead_preview_inviterfriend");
        	String inviterfriend_string = "{candidate:[]}";
        	if(inviterfriend_o == null){
        	}
        	else{
        		inviterfriend_string = (String)inviterfriend_o;
        		inviterfriend_string = inviterfriend_string.replace('\'','`');
        		request.setAttribute("lead_preview_inviterfriend",inviterfriend_string);
        	}
        }
    ...
    <div class="user-data clearfix">
        <div class="title titleimg">
            <h1><strong>点击添加他的朋友圈中的好友</strong></h1>
        </div><!--title end-->
