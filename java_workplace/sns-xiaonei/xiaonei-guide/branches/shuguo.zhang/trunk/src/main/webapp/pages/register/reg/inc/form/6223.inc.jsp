...
<form class="main_regform" method="post" id="regform"  name="regform"
	...
	<div class="form_row" id="d_email">
		...
		<div class="input_wrap">
			...
			<span class="noqqalt">
				如果没有邮箱，你可以用<a id="xid_reg_handle" href="javascript:;">帐号</a>注册
			</span>
	...
	<div class="form_row" id="d_xid" style="display:none">
		...
		<div class="input_wrap">
			...
			<span class="noqqalt">
				<a id="regmail_reg_handle" href="javascript:;">返回邮箱</a>注册
			</span>
		</div>
	</div>
...
<div class="form_row icode_input_row" id="p_icode">
	...
	<div class="form_row p_research" id="p_research">
		<p>请问你最近从哪里看过人人网的广告？</p>
		<label for="recommend">&nbsp;</label>
		<div class="input_wrap">
			<select name="recommend">
   				<option value="请选择">请选择</option>
   				<option value="电视广告">电视广告</option>
				<option value="公交车广告电视广告">公交车广告电视广告</option>
				<option value="电梯电视广告">电梯电视广告</option>
				<option value="杂志">杂志</option>
   				<option value="百度专区">百度专区</option>
   				<option value="其他">其他</option>
            </select>
		</div>
	</div>
	
 	<div class="form_row p_research">
		<p>请问你最近从哪些广告上看到过人人网？</p>
		<label for="recommend1">&nbsp;</label>
		<div class="input_wrap">
			<select name="recommend2">
   				<option value="请选择">请选择</option>
   				<option value="美特斯邦威的广告">美特斯邦威的广告</option>
				<option value="Nokia的广告">Nokia的广告</option>
				<option value="摩托罗拉的广告">摩托罗拉的广告</option>
				<option value="其他">其他</option>
   			</select>
		</div>
	</div>
 	...
 	<div class="form_row p_research">
		<p>请问你为什么来人人网？</p>
		<label for="recommend2">&nbsp;</label>
		<div class="input_wrap">
			<select name="recommend3">
   				<option value="请选择">请选择</option>
   				<option value="被广告吸引">被广告吸引</option>
				<option value="参加活动">参加活动</option>
				<option value="找朋友">找朋友</option>
				<option value="了解朋友的动态">了解朋友的动态</option>
   				<option value="玩游戏">玩游戏</option>
   				<option value="写日志/看照片">写日志/看照片</option>
   				<option value="认识想认识的人，扩大社交圈子">认识想认识的人，扩大社交圈子</option>
   				<option value="随便看看">随便看看</option>
   				<option value="其他">其他</option>
   			</select>
		</div>
	</div>
