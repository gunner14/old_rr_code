...
.abnotinv_login{background-image:url(${applicationScope.urlStatic}/kaixin/imgpro/reg/done_fixed2.png)!important}
            ...
            <div class="kaixin_reg_info">
                ...
                <div class="top_info">
					<div class="message">
						...
						<div class="br">&nbsp;</div>
						<div class="btri">&nbsp;</div>
						<h2>完善个人资料，才能正常登录开心网</h2>
                    	<p>很遗憾，个人档案完整度低会导致无法登录、无法和别人建立关系、无法得到宠物狗狗、无法玩游戏，请完善下面信息后登录:</p>
					</div>
                </div>
				...
				<input type="hidden" name="action_id" id="action_id" value="208103" />
				<input type="hidden" name="g" id="g" value="${requestScope.g}" />
				<input type="hidden" name="b" id="b" value="${requestScope.b}" />
						...
						<table>
							...
							<tr>
								<td colspan="3" class="colspan">
									<button id="reg_sub" type="button" onclick="ismsnok();check1.submit();" style="cursor:pointer;float:left" class="abnotinv_login" tabindex="14">接受好友请求</button>
