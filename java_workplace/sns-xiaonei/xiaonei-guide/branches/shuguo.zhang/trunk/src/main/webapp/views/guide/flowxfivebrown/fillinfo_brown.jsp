    ...
    <div class="user-data">
        ...
        <div class="identity-data">
            <ul class="clearfix" id="choose-identity">
                ...
                <li class="me-secondary"><input name="identity"  type="radio" id="me-secondary"/><label><span>&nbsp;我在上中学</span></label>
        ...
        <div id="work_panel"  class="fill-data work"  style="display:none">
            <form  id="work_form" method="post" action="fibrowns-bl">
            <div class="main-data">
                    <table>
                        <tr id="work_cur_tr">
                        ...
                        <tr id="work_tr">
                            ...
                            <td><input type="text" class="input-text" id="work" name="companyname" /></td>
                        </tr>
                        <tr id="univ_tr">
                            <td class="td-name"><em>*</em>大学 : </td>
                            <td>
                                ...
                                <select class="select select-gray" id="univ_year" name="universityyear" ><option value="">入学年份</option>
                                        <c:set var="strutsOptionYearComponent_begin" value="2009" />
                                        <c:set var="strutsOptionYearComponent_end" value="1900" />
                                        <%@ include file="inc/years.inc" %>
                                </select>
                        ...
                        <tr id="univ_dept_type_tr">
                            <td class="td-name"></td>
                            <td>
                                <select id="univ_dept" class="select select-gray" name="universitydepartment">
                                    <option value="">选择院系</option>
                                </select>
                        ...
                        <tr  id="univ_high_tr">
                            <td class="td-name"><em>*</em>高中 : </td>
                            <td>
                                <input type="text" class="input-text  s-select s-high" id="univ_high" name="highschoolname"/> 
                                <input type="hidden" id="univ_high_id" value="0" name="highschoolcode"/>
                                <select class="select select-gray"  name="highschoolyear" id="univ_high_year">
                                    <option value="">入学年份</option>
                                        <c:set var="strutsOptionYearComponent_begin" value="2009" />
                                        <c:set var="strutsOptionYearComponent_end" value="1900" />
                                        <%@ include file="inc/years.inc"%>
        ...
        <div id="none_panel" class="fill-data other"  style="display:none">
            <form  id="none_form" method="post" action="fillinfos-qt" >
            <div class="main-data">
                    <table>
                        <tr id="none_cur_tr">
                            <td class="td-name"><em>*</em>当前所在地 : </td>
...
<!-- 特定于页面的代码 -->
<script type="text/javascript" src="${applicationScope.urlSmallStatic}/jspro/guide/xn.page.guide.stormAddStage-v1.1.js?ver=$revxxx$"></script>
</body>
</html>
