 ...
 * @deprecated
 */
public class HSPortraitAction extends ProtectAction {
    ...
    public ActionForward executePt(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            Map<String, String> heads = extracted(source);
...
//            host.setHeadUrl(heads.get(HeadManager.HEADNAME_HEAD));
    ...
    private Map<String, String> extracted(MagickImage source) throws Exception {
        return HeadManager.getInstance().processHead(source);
    }
