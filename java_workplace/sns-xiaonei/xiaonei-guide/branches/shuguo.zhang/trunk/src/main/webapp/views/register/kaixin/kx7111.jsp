...
.content{background:url(${applicationScope.urlStatic}/kaixin/imgpro/reg/steal.jpg) no-repeat;height:980px;position:relative;}
.kaixin_reg_info{position:absolute;top:151px;right:68px;}
.form-tip{width:160px;}
.reg_layout{width:490px;margin:0;padding:10px 12px;border:4px solid #F3FFCA;background:#FFF;}
.login-top{position:absolute;top:11px;right:88px;border:1px solid #8c8b8b;background:#f3f3f3;padding:5px;}
       	...
       	<div class="content"> 
            ...
            <div class="kaixin_reg_info">
                ...
                <form action="/rgac.do" id="regform" name="regForm" method="post" class="reg_layout">
                	<input type="hidden" name="action_id" id="action_id" value="207111" />
