 ...
 * @author wang-tai
 */
public class RegisterDirectOthersInviteLogic extends RegisterBaseLogic {

	private RegisterDirectOthersInviteLogic() {
		super();
	}
	...
	private void joinNetwork(User oceUser, RegisterPojo form) {
		...
		reginPojo = new RegNetworkReginPojo(UserAdapter.get(oceUser.getId())
				...
				form.getHomecityname(), form.getWorkplacename());
