...
public class DogBonusAwardModel {
	...
	public String getAward_get_time() {
		return award_get_time;
	}
	public void setAward_get_time(String award_get_time) {
		this.award_get_time = award_get_time;
	}
