...
/**
 * AjaxRequestMultiplyFriendController.java
 * @author inshion(xin.yin@opi-corp.com)
 * 
 * 2010-9-25 添加说明 
 */
@LoginRequired
@Path("requestFriend.do")
public class AjaxRequestMultiplyFriendController {
	@Post
	@Get
									...
									User touser = SnsAdapterFactory.getUserAdapter().get(accepterId);									
	                                    if(touser!=null){
	                                        ...
	                                        try {
	                                            ...
	                                            //fa.setFrom("flash_default");
	                                            GuideXFiveSupportFriendsUtil.beFriendsAsync(host, ids, currentDomain, "flash_default");
	                                        } catch (Exception e) {
