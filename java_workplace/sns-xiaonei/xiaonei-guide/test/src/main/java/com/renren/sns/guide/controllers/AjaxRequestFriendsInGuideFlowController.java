...
/**
 * @author: ji.wei
 * @E-mail: ji.wei@renren-inc.com
 * @create time：2012-4-16 下午06:22:34 类说明
 *
 * 新引导流程中，添加好友的接口，便于统计，独立一个接口出来
 *
 */
@IgnoreUserStatusImportedValidation
@LoginRequired
@Path( { "ajaxRequestFriendsInGuideFlow"})
public class AjaxRequestFriendsInGuideFlowController {
...
//                if (ids != null) {
//                    log.info(" host:" + host.getId() + ";from_flag is not null;ids.length:" + ids.length);
//                } else {
//                    log.info(" host:" + host.getId() + ";from_flag is null;ids is null");
//                }
//                return "@";
//            } else if ("_".equals(from_flag)) {
//                if (ids != null) {
//                    log.info(" host:" + host.getId() + ";from_flag is _;ids.length:" + ids.length);
//                } else {
//                    log.info(" host:" + host.getId() + ";from_flag is _;ids is null");
//                }
//            }
                                ...
                                if (accepterId > 0) {
                                    ...
                                    if (touser != null) {
                                        ...
                                        try {
                                            ...
                                            GuideLogger.printLog(" host:" + host.getId()  + " stage:"+host.getStage()+ " to:" + touser.getId() + " " + msg + ":" + rst.getResult());

                                            GuideStatLogUtil.log("User:" + host.getId() + "|Action:requestFriend|to:" + touser.getId() + "|stage:" + host.getStage()+"|from_flag:" + from_flag+"|pos:"+pos);
                                        } catch (Exception e) {
                                            e.printStackTrace();
                                        }
                                    }
