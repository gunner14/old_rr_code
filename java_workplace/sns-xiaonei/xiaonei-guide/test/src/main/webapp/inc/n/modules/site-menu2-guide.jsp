			...
			<c:if test="${!host.page}">
				<div class="apps-item">
					<div class="item-title">
						...
						<a stats="V6Guideleft_appCenter" href="http://app.renren.com/apps/track/homeView?originUrl=http://app.renren.com&origin=50116" target="_blank" onclick="if($('newAppsTody')){$('newAppsTody').hide();}" class="with-count"> <img width="16" height="16" src="${applicationScope.urlStatic}/imgpro/v6/icon/app.png" class="icon"> 应用中心</a>
						</span>
					</div>
				</div>
