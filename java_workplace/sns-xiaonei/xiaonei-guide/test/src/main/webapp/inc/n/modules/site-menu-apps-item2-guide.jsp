	...
	<c:choose>
			...
			<div class="apps-item" id="appsItem_${item.appId}">
				<div class="item-title">
					<span class="item-main">
						<a ${stats} ui-async="async" href="http://photo.renren.com/photo/${visiter.id}/album/friends?origin=${origin}">
		...
		<c:otherwise>
			<div class="apps-item" id="appsItem_${item.appId}">
				<div class="item-title">
					<span class="item-main">
						<a ${stats} href="${sideNavUrl}${sp}origin=${origin}"${target}<c:if test="${item.appId==60||item.appId==95003||item.appId==120019||item.appId==166607||item.appId==166613||item.appId==166614||item.appId==166615||item.appId==166617}"> ui-async="async"</c:if>>
							<c:choose>
