...
<style type="text/css">
#regform{padding-top:18px;}
.inputholder{width:240px!important;}
.reg_layout td{padding-top:10px}
.reg_layout th{padding-top:13px}
.kaixin_friends{border:1px solid #e9e9e9;padding-top:10px;width:246px;}
.content{background:url(${applicationScope.urlStatic}/kaixin/imgpro/reg/titi.jpg) no-repeat;height:1145px;position:relative;}
.kaixin_reg_info{position:absolute;top:259px;right:83px;}

.form-tip{width:160px;}
.reg_layout{width:490px;margin:0;padding:10px 12px;border:3px solid #F68702;background:#FFF;}
.login-top{position:absolute;top:35px;right:115px;border:1px solid #8c8b8b;background:#f3f3f3;padding:5px;}
.login-top p{margin:0 0 5px;}
.login-top p .w150{width:150px;}
.login-top p label{font-weight:400;margin:0 7px 0 0;}
.login-top .enter{text-align:center;margin:5px 0 0;}
</style>
</head>
<body>
	<div class="mainbox">
       	...
       	<div class="content"> 
            ...
            <div class="kaixin_reg_info">
                ...
                <form action="/rgac.do" id="regform" name="regForm" method="post" class="reg_layout">
                	<input type="hidden" name="action_id" id="action_id" value="207112" />
