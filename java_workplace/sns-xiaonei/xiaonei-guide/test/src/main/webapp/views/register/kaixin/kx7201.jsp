...
<meta name="Description" content="开心网是一个与朋友、同学、同事、家人一块玩的地方，可以通过朋友认识更多人，大家一块养宠物狗狗，抢车位，在开心农场种自己喜欢的蔬菜水果，让朋友相互更加了解，联系更加紧密。">
...
<body id="syshome">
    ...
    <!--head-->
    <div id="header">
		<div id="logo"><a href="${applicationScope.urlHome}/Home.do?id=${requestScope.host.id}" title="开心网"><img src="${applicationScope.urlStatic}/kaixin/imgpro/logo/v2_logo.png" alt="开心网"></a></div>
...
<!--begin -->
	<div class="sidebar">
		<div class="inner">
			...
			<form method="post" id="loginForm" action="http://www.renren.com/PLogin.do" class="login-form">			
				<p class="top">
		...
		<div class="reg-guide">
			...
			<div class="goreg">
				...
				<a class="gotoreg" href="http://reg.kaixin.com/register.do?ss=${requestScope.ss}&rt=${requestScope.rt}&b=${requestScope.b}">立即注册</a>
			</div>
			<div class="innerbottom">&nbsp;</div>
		</div>
	...
	<div class="widebar">
		...
		<div class="infobox clearfix">
			...
			<div class="sign-up">
				<a class="regbutton" href="http://reg.kaixin.com/register.do?ss=${requestScope.ss}&rt=${requestScope.rt}&b=${requestScope.b}">&nbsp;</a>
				<div class="ucando">
					<dl>
						<dt>加入开心网你可以:</dt>
