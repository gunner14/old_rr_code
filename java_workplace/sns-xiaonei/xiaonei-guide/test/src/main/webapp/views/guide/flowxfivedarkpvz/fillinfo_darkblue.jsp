...
<div id="content" class="content-first">
    <%
    ...
    <div class="user-data">
        <h2><strong>完善资料，让朋友快点找到我。</strong></h2>
        <div class="identity-data">
            <ul class="clearfix" id="choose-identity" style="position:relative;">
            	
            		<div id="choose-box" class="choose-box" style="display:none">
									<input id="show-junior" type="button" value="初中" class="input-submit" />
									<input id="show-high" type="button" value="高中" class="input-submit" />
									<input id="show-tech" type="button" value="中专技校" class="input-submit" />
								</div>
								
                <li class="me-work">
									<input type="submit" name="identity" id="me-work" value=""/>
								</li>
								<li class="me-university">
									<label for="me-university"><span><input name="identity"  type="submit" id="me-university" value=""/></span></label>
								</li>   
								<li class="me-secondary">
									<label for="me-secondary"><span><input name="identity"  type="submit" id="me-secondary" value=""/></span></label>
								</li>
								<li class="me-other">
									<label for="me-other"><span><input type="submit" name="identity" id="me-other" value=""/></span></label>
								</li>
            </ul>
...
<!-- 特定于页面的代码 -->
<script type="text/javascript" src="${applicationScope.urlSmallStatic}/jspro/guide/xn.page.guide.pvz.js?ver=$revxxx$"></script>
<script type="text/javascript">
