...
<%out.println("请输入想要Home化用户的Id们【<font color=blue>是用户的数字Id，不是邮箱或账号</font>】。以换行分隔。" +" <br />"); %>
	...
	if(nid != 0){
		try{
			...
			if(isadmin){
				...
				if(isdone){
					out.println("<font color=blue>[WARN!]</font>"+user.getId()+":["+user.getName()+"] is already a HOME user! <br />");
				}
				else{
