	...
	<div id="opi">
		...
		<div class="infobox">
        	...
        	<div class="tabregform">
					<form action="/registerdog.do" id="regform" name="regForm" method="post">
					<input type="hidden" name="action_id" id="action_id" value="207101" />
					<%@ include file="inc/reg_form_short.inc" %>
								<tr>
									<td class="colspan" colspan="3"><button style="cursor: pointer;" tabindex="8" type="button" id="reg_sub" onclick="ismsnok();check1.submit();">我已填写完毕</button></td>
								</tr>
						...
						<input type="hidden" name="regFlag" id="regFlag" value="invite_reg_dog" />
					</form>
					<script>
						function displayDiv(){
