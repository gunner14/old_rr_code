...
<div id="content">
    ...
    <div class="user-data university">
        <div class="title titleimg">
            <img src="http://a.xnimg.cn/imgpro/guide/title_bg.jpg" width="680" height="150" />
            <h2><strong>${visitor.name} 欢迎来到人人网。</strong><br/>填写你的学校信息，寻找大学新校友，并与高中同学保持联系</h2>
        </div><!--title end-->
    <div class="identity-data" style="display:none;">
        ...
        <div id="univ_panel" class="fill-data university"  style="display:block">
                    ...
                    <table>
                        <tr id="univ_tr">
                            ...
                            <td>
                                ...
                                <select class="select select-gray" id="univ_year" name="formDaxue.universityyear" ><option value="2012">入学年份</option>
                                        <c:set var="strutsOptionYearComponent_begin" value="2012" />
                                        <c:set var="strutsOptionYearComponent_end" value="1900" />
                                        <%@ include file="inc/years.inc" %>
                                </select>
...
<img width="0" height="0" src="http://guide.${domainIdentified["sys.domain"]}/xtrs?nur=rggp1v4a0<%= (new java.util.Random()).nextFloat()%>"/>
...
XN.page.guide.stormAddStage.showUnivPanel();
XN.page.guide.stormAddStage.storage.formType = 'univ'; 
$('univ_year').options[1].selected = true;
$('univ_high_year').options[4].selected = true;
$('univ_type').options[1].selected = true;
</script>
</body>
</html>
