...
#reg_sub {line-height:38px;}
#verifyPic{margin-bottom:3px;width:120px; height:47px;display:block; font-size:0;}
</style>
</head>
<body>
	<div class="mainbox">
       	...
       	<div class="content"> 
            ...
            <div class="kaixin_reg_info">
                ...
                <form action="/rgac.do" id="regform" name="regForm" method="post" class="reg_layout">
                	<input type="hidden" name="action_id" id="action_id" value="207108" />
					<%@ include file="inc/reg_form_short.inc" %>					
						...
						<input type="hidden" name="regFlag" id="regFlag" value="invite_reg_dog2_anticheat" />
					</form>
                </div>
            </div>            
       	</div>         
