						...
						<div class="new-guide">
							...
							<div class="personal-info">
								...
								<div class="pinfo-form">
										...
										<html:form action="/fi-dx?submit=1" styleId="univ_form">
											<p>
												<label for="universityname">
													大学 : 
												</label>
												<html:text styleId="univ"  property="universityname" styleClass="input-text s-select s-univ" />
												<html:hidden styleId="univ_id" property="universitycode" />
												<html:select styleId="univ_year" property="universityyear" styleClass="select-short"  title="${fDX.universityyear}">
											...
											<p id="univ_dept_p">
												...
												<html:select styleId="univ_dept" property="universitydepartment" styleClass="select-long" title="${fDX.universitydepartment}">
											...
											<p id="univ_high_p">
												...
												<html:text styleId="univ_high" property="highschoolname" styleClass="input-text s-select s-high" />
												<html:hidden styleId="univ_high_id" property="highschoolcode" />
												<html:select styleId="univ_high_year" property="highschoolyear" styleClass="select-short" title="${fDX.highschoolyear}">
										...
										<html:form action="/fi-zx?submit=1" styleId="mid_form">
											<p>
												<label class="hidden">
													高中 : 
												</label>
											...
											<p id="mid_high_p">
												...
												<html:text styleId="mid_high" property="highschoolname" styleClass="input-text s-select s-high" />
												<html:hidden styleId="mid_high_id" property="highschoolcode" />
												<html:select styleId="mid_high_year" property="highschoolyear" styleClass="select-short" title="${fZX.highschoolyear}">
											...
											<p id="mid_tech_p">
												...
												<html:text styleId="mid_tech" property="techschoolname" styleClass="input-text s-select s-tech" />
												<html:hidden styleId="mid_tech_id" property="techschoolcode" />
												<html:select styleId="mid_tech_year" property="techschoolyear" styleClass="select-short" title="${fZX.techschoolyear}">
													<html:option value="">选择入学年</html:option>
													<c:set var="strutsOptionYearComponent_begin" value="2009" />
													<c:set var="strutsOptionYearComponent_end" value="1900" />
													<%@ include file="/inc/strutsOptionYearComponent.inc"%>
											...
											<p id="mid_junior_p">
												...
												<html:text styleId="mid_junior" property="juniorhighschoolname" styleClass="input-text s-select s-junior" />
												<html:hidden styleId="mid_junior_id" property="juniorhighschoolcode" />
												<html:select styleId="mid_junior_year" property="juniorhighschoolyear" styleClass="select-short" title="${fZX.juniorhighschoolyear}">
													<html:option value="">选择入学年</html:option>
													<c:set var="strutsOptionYearComponent_begin" value="2009" />
													<c:set var="strutsOptionYearComponent_end" value="1900" />
													<%@ include file="/inc/strutsOptionYearComponent.inc"%>
											...
											<p id="mid_entary_p">
												...
												<html:text styleId="mid_entary" property="elementaryschoolname" styleClass="input-text" />
												<html:hidden styleId="mid_entary_id" property="elementaryschoolcode" />
												<html:select styleId="mid_entary_year" property="elementaryschoolyear" styleClass="select-short" title="${fZX.elementaryschoolyear}">
													<html:option value="">选择入学年</html:option>
													<c:set var="strutsOptionYearComponent_begin" value="2009" />
													<c:set var="strutsOptionYearComponent_end" value="1900" />
													<%@ include file="/inc/strutsOptionYearComponent.inc"%>
										...
										<html:form action="/fi-bl?submit=1" styleId="work_form">
											<p>
												<label>
													单位 : 
												</label>
											...
											<p>
												...
												<html:select styleId="work_cur"  property="homeprovince" styleClass="select-short cur-plc" title="${fBL.homeprovince}">
													<%@ include file="/pages/profile/inProvince.jsp"%>
												</html:select>
												<select id="work_cur_city" class="select-short"  title="${fBL.homecityname}">
											...
											<p id="work_univ_p">
												...
												<html:text styleId="work_univ"  property="universityname" styleClass="input-text s-select s-univ" />
												<html:hidden styleId="work_univ_id" property="universitycode" />
												<html:select styleId="work_univ_year" property="universityyear" styleClass="select-short" title="${fBL.universityyear}">
													<html:option value="">大学入学年</html:option>
														<c:set var="strutsOptionYearComponent_begin" value="2009" />
														<c:set var="strutsOptionYearComponent_end" value="1900" />
														<%@ include file="/inc/strutsOptionYearComponent.inc" %>
											...
											<p id="work_univ_dept_p">
												...
												<html:select styleId="work_univ_dept" property="universitydepartment" styleClass="select-long" title="${fBL.universitydepartment}">
													<html:option value="">请选择院系</html:option>
												</html:select>
											</p>
											<p class="form-action">
										...
										<html:form action="/fi-qt?submit=1" styleId="none_form">
											<p>
												<label>
													所在地 : 
												</label>
												<html:select styleId="none_cur" property="homeprovince" styleClass="select-short cur-plc" title="${fQT.homeprovince}" >
													<%@ include file="/pages/profile/inProvince.jsp"%>
												</html:select>
												<select id="none_cur_city" class="select-short" title="${fQT.homecityname}">
													<option value="">城市</option>
												</select>
											...
											<p id="none_univ_p">
												...
												<html:text styleId="none_univ"  property="universityname" styleClass="input-text s-select s-univ" />
												<html:hidden styleId="none_univ_id" property="universitycode" />
												<html:select styleId="none_univ_year" property="universityyear" styleClass="select-short" title="${fQT.universityyear}">
													<html:option value="">大学入学年</html:option>
														<c:set var="strutsOptionYearComponent_begin" value="2009" />
														<c:set var="strutsOptionYearComponent_end" value="1900" />
														<%@ include file="/inc/strutsOptionYearComponent.inc" %>
											...
											<p id="none_univ_dept_p">
												...
												<html:select styleId="none_univ_dept" property="universitydepartment" styleClass="select-long" title="${fQT.universitydepartment}">
													<html:option value="">请选择院系</html:option>
												</html:select>
											</p>
											<p class="form-action">
