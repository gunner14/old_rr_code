...
<form action="/invitereg.do" onsubmit="return false;" method="post" id="regform"  name="regform">
	...
	<div  class="form_row" id="d_email">
		...
		<div class="input_wrap">
			...
			<span id="span_xid_tip" onclick="javascirpt:regType('xid');" class="noqqalt" style="display:none">如果没有邮箱，可以直接使用<a href="#reg_id">字符</a>注册</span>
		</div>
	...
	<div class="form_row" id="d_xid"  style="display:none">
		...
		<div class="input_wrap">
			...
			<span onclick="javascirpt:regType('email');" class="noqqalt" >我想用<a href="#reg_mail">手机号或邮箱</a>注册</span>
		</div>
		<div class="box-error" id="nicknameId_error_span">
			<div class="box-error-outer">
				<div class="box-error-inner">											
					<p id="nicknameId_error_span_i">6-20位<font color="red">字母及数字组合</font>（不含纯数字）；此帐号用来登录网站，注册后不可更改，请牢记</p>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="form_row" id="p_highSchoolName0" style="display:none">
		...
		<div class="input_wrap">
			...
			<input type="text" name="highSchoolName" id="highSchoolName0" class="inputtext" onclick="SchoolComponent.show(SchoolComponent.OPEN_HIGH_SCHOOL,'highSchoolName0','highSchoolCode0');" readonly="true" />
	...
	<div id="techHighSchoolContainer" class="posrela"></div>
		...
		<!-- 
		<div class="form_row" id="p_enrollYear" style="display:none">
			<label for="">入学年:</label>
			<div class="input_wrap">
			...
			<div class="box-error" id="enrollyear_error_span">
				<div class="box-error-outer">
					<div class="box-error-inner">											
						<p id="enrollyear_error_span_i">请选择正确入学年</p>
					</div>
				</div>
			</div>
		</div>	
