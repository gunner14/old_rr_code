...
<form action="/commonreg.do" onsubmit="return regSubmitKuang();" method="post" id="regform"  name="regform">
							...
							<div  class="form_row" id="d_email">
								...
								<div class="input_wrap">
									...
									<span id="span_hotmail_tip" class="noqqalt"><%--如果没有邮箱，请注册5GB的<a href="http://reg.${applicationScope.sysdomain}/pages/register/sbjumplink.jsp" target="_blank">Hotmail</a>邮箱 --%></span>
							...
							<div class="form_row">
									...
									<div id="dialog_buttons" class="dialog_buttons">
										<input type="button" id="dialog_button_submit" onfocus="this.blur()" onclick="if(true != regSubmitKuang()){return;};$('regform').submit();"  class="inputsubmit" value="完成领养"/>
									</div>
