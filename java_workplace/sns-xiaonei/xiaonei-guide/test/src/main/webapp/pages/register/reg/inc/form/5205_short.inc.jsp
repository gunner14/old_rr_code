...
<form class="main_regform" method="post" id="regform"  name="regform"
	...
	<div class="form_row" id="p_birthday"><label>生日:</label>
	<div class="input_wrap"><select name="birth_year"
		id="birth_year" >
	...
	</select> 年 <select name="birth_month" id="birth_month"
		>
		<option value="">--</option>
	...
	</select> 月 <select name="birth_day" id="birth_day"
		>
		<option value="">--</option>
	...
	<p class="b_tip"><a href="javascript:;"
		onclick="XN.DO.confirm('出于安全考虑，同时为了保证人人网用户的真实性，凡注册人人网用户都需要填写真实的出生日期。<br /><span class=\'gray\'>你可以在个人主页上隐藏你的出生日期。</span>',
	'为什么需要提供我的生日日期？')">为什么要填写我的生日？</a></p>
	</div>
	</div>
	...
	<label id="regmail_label" for="nicknameId">注册ID:</label>
