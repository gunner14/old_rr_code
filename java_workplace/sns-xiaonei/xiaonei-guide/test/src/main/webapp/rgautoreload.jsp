...
<%@page import="com.renren.sns.lead.core.LeadConfigUtil"%>
<%@page import="com.xiaonei.reg.guide.util.GuideTimeCost"%>
<%@page import="com.xiaonei.reg.guide.util.GuideLogger"%>
<%@page import="com.xiaonei.reg.guide.action.a090729.MyTimeCost"%>
...
A090729Util.reloadProperties();
GuideLogger.reloadConfigMap();
MyTimeCost.reloadConfigMap();
GuideTimeCost.reloadConfigMap();
LeadConfigUtil.reloadConfigMap();
