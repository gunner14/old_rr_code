...
dstr1 = time.strftime("%y-%m-%d [16 - 23]",time.localtime())
...
mes += "Index >>" 
mes += "<a href=\"#avg\">Average Report [16 - 23]</a>"
...
myfile = open(PATH+"stat.ret.txt.all.1623.merged")
id = 0
for line in myfile:
    words = line.split('|')
    if len(words) > 10:
...
mes += "<table align=\"center\">"
mes += "<th>St(Cnt)</th><th>Req</th><th>Average</th><th>Count</th><th>[0,100]</th><th>(100,300]</th><th>(300,1000]</th><th>(1000,"+str_unlimit+")</th></tr>\n"
myfile = open(PATH+"stat.ret.txt.35.all.1623.merged")
id = 0
for line in myfile:
    words = line.split('|')
    if len(words) > 10:
...
mes += "<table align=\"center\">"
mes += "<th>St(Cnt)</th><th>Req</th><th>Average</th><th>Count</th><th>[0,100]</th><th>(100,300]</th><th>(300,1000]</th><th>(1000,"+str_unlimit+")</th></tr>\n"
myfile = open(PATH+"stat.ret.txt.36.all.1623.merged")
id = 0
for line in myfile:
    words = line.split('|')
    if len(words) > 10:
