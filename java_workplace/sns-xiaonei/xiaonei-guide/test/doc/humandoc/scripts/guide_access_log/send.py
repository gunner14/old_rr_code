...
dstr1 = time.strftime("%y-%m-%d %H:%M:%S[last 1 hour]",time.localtime())
...
mes += "Index >>" 
mes += "<a href=\"#avg\">Average Report of Last 1 Hout</a>"
...
mes += "<table align=\"center\">"
mes += "<th>St(Cnt)</th><th>Req</th><th>Average</th><th>Count</th><th>[0,100]</th><th>(100,300]</th><th>(300,1000]</th><th>(1000,"+str_unlimit+")</th></tr>\n"
myfile = open(PATH+"stat.ret.txt.35")
id = 0
for line in myfile:
    words = line.split('|')
    if len(words) > 9:
...
mes += "<table align=\"center\">"
mes += "<th>St(Cnt)</th><th>Req</th><th>Average</th><th>Count</th><th>[0,100]</th><th>(100,300]</th><th>(300,1000]</th><th>(1000,"+str_unlimit+")</th></tr>\n"
myfile = open(PATH+"stat.ret.txt.36")
id = 0
for line in myfile:
    words = line.split('|')
    if len(words) > 9:
...
msg['To'] = 'xin.yin@opi-corp.com'
msg['From'] = 'xin.yin@opi-corp.com'
msg['Cc'] = 'xin.yin@opi-corp.com,wei.xiang@opi-corp.com'
msg['Date'] = Utils.formatdate(localtime = 1)
msg['Subject'] ='[yx] Guide Performance Report '+dstr1

s = smtplib.SMTP("mail.opi-corp.com")
tomail = ['xin.yin@opi-corp.com']
#tomail = ['xin.yin@opi-corp.com','wei.cheng@opi-corp.com']
#tomail = ['xin.yin@opi-corp.com','wei.xiang@opi-corp.com']
