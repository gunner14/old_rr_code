...
# build project
echo "================== begin to build ================"
mvn -f pom-stat.xml clean package >> $BUILD_LOG 2>&1
ret=$?
checkresult $ret
