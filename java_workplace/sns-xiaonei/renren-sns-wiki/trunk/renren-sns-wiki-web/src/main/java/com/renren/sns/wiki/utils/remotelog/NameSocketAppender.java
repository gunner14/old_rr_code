...
/**
    ...
    @since 0.8.4 */
public class NameSocketAppender extends AppenderSkeleton {
  ...
  */
  ...
  public NameSocketAppender() {
  }

  /**
     Connects to remote server at <code>address</code> and <code>port</code>.
  */
  public NameSocketAppender(InetAddress address, int port) {
  ...
  */
  public NameSocketAppender(String host, int port) {
    this.port = port;
  ...
  */
  class Connector extends Thread {
    ...
    try {
      ...
      // fetch remote host address by name 
      // avoid host change added by yi.li@renren-inc.com
