...
import com.dodoyo.invite.httpservice.logic.ServiceStatusLogic;
...
public class ServiceManageAction extends Action {
    private static final ClientIPDao clientDao = new ClientIPDao();
    ...
    protected ActionForward hanleRequest(ActionMapping mapping,
        ...
        LogUtils.logInfo("current action = " + action);
        ...
        if ("login".equals(action)) {
            LogUtils.logInfo("do login ....");
            String userName = request.getParameter("user_name");
            String password = request.getParameter("password");
            LogUtils.logInfo("userName = " + userName + ", password = " + password);
            if ("admin".equals(userName) && "pass".equals(password)) {
                request.getSession(true).setAttribute("admin", userName);
                LogUtils.logInfo("login success, session = " + request.getSession().getAttribute("admin"));
