...
public class LinkConfUtils {
    ...
    private void init() {
        ...
        for (int i = 0; i < ssList.size(); i++) {
            ...
            LogUtils.logInfo(ssElement.attributeValue("name"));
            LogUtils.logInfo(ssElement.attributeValue("value"));
        ...
        LogUtils.logInfo("link conf init over ....document == null ? " + (document == null));
    }
    ...
    private void init2() {
        ...
        LogUtils.logInfo("2 link conf init over ....document2 == null ? " + (document2 == null));
    }
