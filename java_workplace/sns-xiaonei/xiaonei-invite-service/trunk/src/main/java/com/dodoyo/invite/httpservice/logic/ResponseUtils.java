...
public class ResponseUtils {
    ...
    public String getResponseXMLForLinkInviteAll(Map<String, String> linkMap, int result) {
        ...
        for (Entry<String, String> e : linkMap.entrySet())
            sb.append("<link group=\"" + e.getKey() + "\">").append(e.getValue()).append("</link>");
    ...
    public String getResponseXMLForExportContacts(ExportRequestParam exportReqParam,
        ...
        if (ics != null) {
            LogUtils.logDebug("++++getResponseXMLForExportContacts, ics.size = " + ics.getBuddies().size());
            ...
            for (Entry<String, ContactInfo> e : kvSet) {
                LogUtils.logDebug("++++++email = " + e.getKey());
