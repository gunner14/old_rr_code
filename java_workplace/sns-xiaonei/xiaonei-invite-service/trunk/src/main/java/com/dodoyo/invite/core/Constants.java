...
public class Constants {
    ...
    public static final String WEB_APP_PATH = "/opt/inviteservice_www/";

    //vm模板的读取位置
    public static String REPLOAD_VELOCITY_PROPERTIES = WEB_APP_PATH + "WEB-INF/conf/velocity_invite.properties";

    public static String EMAIL_CONFIG_PATH = WEB_APP_PATH + "WEB-INF/conf/email.xml";

    public static String EMAIL_CONFIG_PATH2 = WEB_APP_PATH + "WEB-INF/conf/email2.xml";

    public static String LINK_CONFIG_PATH = WEB_APP_PATH + "WEB-INF/conf/invite_link_conf.xml";
    
    public static String LINK_CONFIG_PATH2 = WEB_APP_PATH + "WEB-INF/conf/invite_link_conf2.xml";

    public static String RELOAD_VELOCITY_TEMPALATE_XML = WEB_APP_PATH + "WEB-INF/conf/templateConfig_invite.xml";
    ...
    public static final String UUID_GEN_KEY = "renren-!@#$!QAZ-invite";
}
