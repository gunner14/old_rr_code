...
public class InviteServiceLogicImpl implements InviteServiceLogic {
    ...
    public InviteServiceLogicImpl() {
    }

    /*private static InviteServiceLogicImpl isl = new InviteServiceLogicImpl();

    private static InviteServiceLogicImpl getInstance() {
        return isl;
    }*/
    ...
    public String doLinkInvite(HttpServletRequest request) {
        ...
        try {
            ...
            //authentications
            int authRet = authLogic.linkAuthLogic(linkReqObj);
            ...
            link = inviteFacade.getURLForLinkInvite(linkReqObj.getBaseLink(),
...
//            if (StringUtils.isNotEmpty(linkReqObj.getExp()) && StringUtils.isNotEmpty(link)) {
//                link += "&" + linkReqObj.getExp();
//            }
        }
        catch (Exception e) {
    ...
    public String doLinkInviteAll(HttpServletRequest request) {
        ...
        try {
            ...
            //send link request with core facade
            linkMap = inviteFacade.getURLForLinkInviteAll(linkReqObj.getBaseLink(), linkReqObj.getInviterId(), linkReqObj.getAppId());
        }
        catch (Exception e) {
            LogUtils.logErr("doLinkInvite exception ....");
            LogUtils.logExceptionStack(e);
    ...
    public String doMailInvite(HttpServletRequest request) {
        ...
        try {
            ...
            //authentications
            int authRet = authLogic.mailAuthLogic(mailReqObj);
            if (authRet != Constants.INVITE_RESULT_SUCCESS) {
            ...
            for (String mail : mailArr) {
                ...
                ss = inviteFacade.sendInviteMailForImport(mailReqObj.getFromer(), mailReqObj.getInviterId(),
            ...
            e.printStackTrace(System.err);
            LogUtils.logExceptionStack(e);
            LogUtils.logDebug("do mail invite service exeception, return INVITE_RESULT_EXCP");
    ...
    public String doMailExportReq(HttpServletRequest request) {
        ...
        try {
            ...
            e.printStackTrace(System.err);
            LogUtils.logExceptionStack(e);
            LogUtils.logDebug("do mail export request service exeception, return INVITE_RESULT_EXCP");
    ...
    public String doMailExportQuery(HttpServletRequest request) {
        ...
        try {
            //get paramters
            exportReqObj = RequestParamFactory.getInstance().getExportRequestParam(request);
            LogUtils.logDebug("doMailExportQuery datas: " + exportReqObj);

            //authentications
            int authRet = authLogic.mailExportQueryAuthLogic(exportReqObj);
            if (authRet != Constants.INVITE_RESULT_SUCCESS) {
    ...
    public String doMailExportInviteWithCallback(HttpServletRequest request) {
        ...
        try {
            ...
            LogUtils.logDebug("doMailExportInviteWithCallback datas: " + exportReqObj);
    ...
    public String doMailExportWithCallback(HttpServletRequest request) {
        ...
        try {
            exportReqObj = RequestParamFactory.getInstance().getExportRequestParam(request);
            LogUtils.logDebug("doMailExportWithCallback datas: " + exportReqObj);
    ...
    private String sendExportRequest(ExportRequestParam exportReqObj, boolean isSendInvite, boolean isCallback) {
        //authentications
        int authRet = authLogic.mailExportReqAuthLogic(exportReqObj);
        if (authRet != Constants.INVITE_RESULT_SUCCESS) {
