...
public class ServiceInvocationHandler implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        try {
            while (true) {
                xoaTransport = serviceRouter.routeService(serviceId, version, null);
            ...
            serviceRouter.serviceException(serviceId, version, e, xoaTransport);
            throw e;
            ...
            if (cause instanceof org.apache.thrift.TBase) {
                ...
                serviceRouter.serviceException(serviceId, version, cause, xoaTransport);
            }
            throw cause;
        } catch (Exception e) {
            Throwable cause = e.getCause();
