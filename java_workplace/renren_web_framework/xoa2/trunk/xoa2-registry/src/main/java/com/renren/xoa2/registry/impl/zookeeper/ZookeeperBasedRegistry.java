...
public class ZookeeperBasedRegistry extends AbstractXoaRegistry {
	...
	@Override
	public boolean registerService(String serviceId, int serviceGroupId,
			int shardParam, Node node) {
		// TODO Auto-generated method stub
		return false;
	}

	@Override
	public boolean disableService(String serviceId, int serviceGroupId,
			int shardParam, Node node) {
		// TODO Auto-generated method stub
		return false;
	}
