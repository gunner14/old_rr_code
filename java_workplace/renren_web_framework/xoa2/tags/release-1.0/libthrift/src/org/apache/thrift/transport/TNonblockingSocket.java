...
public class TNonblockingSocket extends TNonblockingTransport {
  ...
  public String getDescription() {
	  if (socketChannel_ != null && socketChannel_.socket() != null) {
		  InetSocketAddress addr = (InetSocketAddress)socketChannel_.socket().getRemoteSocketAddress();
		  StringBuilder sb = new StringBuilder();
		  sb.append(addr.getAddress().getHostAddress())
		  	.append(':').append(addr.getPort());
		  return sb.toString();
	  }
	  return "bad-sock-channel";
  }
