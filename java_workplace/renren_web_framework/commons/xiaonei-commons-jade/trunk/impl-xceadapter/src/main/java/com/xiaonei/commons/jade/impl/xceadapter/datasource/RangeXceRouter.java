...
public class RangeXceRouter implements XceRouter {
     ...
     */
    public RangeXceRouter(String column, String pattern) {
        this.column = column;
    ...
    private Date convert(Object columnValue) throws SQLSyntaxErrorException {
        ...
        if (columnValue instanceof Date) {
            ...
            try {
                ...
                throw new SQLSyntaxErrorException("Column \'" + column
                        + "\' must be date/time, but: " + columnValue);
            }
        }
    }
