...
public class MysqlParser implements/*@bgen(jjtree)*/ MysqlParserTreeConstants,com.meidusa.amoeba.parser.Parser, MysqlParserConstants {/*@bgen(jjtree)*/
  ...
  final public Statment parse() throws ParseException {
    ...
    case 0:
      jj_consume_token(0);
      break;
    /* TODO: fix code by han.liao:
     * fix {USE|IGNORE|FORCE} INDEX (...) WHERE exception
     */
    case K_WHERE:
      ...
      /* fix code end */
        ...
        if(statment instanceof DMLStatment){
                List<Table> list = new ArrayList<Table>();
                         ...
                         * fix {USE|IGNORE|FORCE} INDEX (...) WHERE exception
                         */
                        if (expression != null) { ((DMLStatment)statment).setExpression(expression); }
                        /* fix code end */
        }
...
Expression expression = null;
  ...
  final public Statment InsertQuery() throws ParseException {
    ...
    table = TableName();
    /* TODO: fix code by han.liao:
     * fix INSERT [IGNORE|DELAYED] [INTO] ... statement. 
     */
    if ("IGNORE".equalsIgnoreCase(table.getName()) ||
        "DELAYED".equalsIgnoreCase(table.getName())) {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case K_INTO:
          jj_consume_token(K_INTO);
          break;
        ...
        tableStack.pop();
        tableAliasMap.remove(table.getName());
        table = TableName();
    }
    /* fix code end */
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
...
*/
  ...
  final public String EntityName() throws ParseException {
    ...
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    /* TODO: fix code by han.liao:
     * excaption on 'year', 'month', 'day', 'hour', 'minute', 
     * 'second', 'microsecond' column names.
     * origin code is:  
     *  
     * case IDENTIFIER:
    ...
    case K_SECOND:
    case K_MICROSECOND:
      token = jj_consume_token((jj_ntk==-1)?jj_ntk():jj_ntk);
                {if (true) return token.image;}
      break;
    /* fix code end */
    case S_QUOTED_IDENTIFIER:
...
/* Checks for whatever follows  SELECT */
  ...
  final public void SelectItem() throws ParseException {
    ...
    case K_MICROSECOND:
      ...
      jj_consume_token((jj_ntk==-1)?jj_ntk():jj_ntk);
      break;
    /* end fix code */
    default:
      jj_la1[67] = jj_gen;
...
//generic function defination
  final public Expression OverloadedFunctionCall() throws ParseException {
    ...
    case 128:
      ...
      /* TODO: fix code by han.liao 
       * fix PostgreSQL: SELECT NEXTVAL('name'::text)
       * 
       * origin code:
       * 
       *  jj_consume_token(130);
  ...
  private boolean jj_3R_50() {
    ...
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      ...
      case K_SECOND:
      case K_MICROSECOND:
        if (jj_scan_token((jj_ntk==-1)?jj_ntk():jj_ntk)) return true;
        break;
      default:
        if (jj_scan_token(IDENTIFIER)) return true;
        break;
