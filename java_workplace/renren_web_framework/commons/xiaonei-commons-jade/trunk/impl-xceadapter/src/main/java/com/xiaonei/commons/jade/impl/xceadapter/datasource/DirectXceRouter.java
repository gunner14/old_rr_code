 ...
 * @author han.liao
 */
public class DirectXceRouter implements XceRouter {

    // 输出日志
    protected static final Log logger = LogFactory.getLog(DirectXceRouter.class);
     ...
     */
    public DirectXceRouter(String column, String pattern) {
        this.column = column;
