 ...
 * @author han.liao
 */
public class RemoteXmlDocXceConfigurator extends XmlDocXceConfigurator {
     ...
     */
    public RemoteXmlDocXceConfigurator() {
     ...
     * @param url - 配置网络路径
     */
    public RemoteXmlDocXceConfigurator(URL url) {
     ...
     * @param file - 配置本地路径
     */
    public RemoteXmlDocXceConfigurator(File file) {
            ...
            if (args.length < 2) {
                ...
                if (filePath.indexOf(':') >= 2) {
                    ...
                    try {
                        ...
                        new RemoteXmlDocXceConfigurator(url);
                    ...
                    new RemoteXmlDocXceConfigurator(file);
                }
            }
