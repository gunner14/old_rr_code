 ...
 */
package com.xiaonei.util.errorhandling;
 ...
 * used within TC software components - it provides all the logic of Java 1.5
 * errors (message, stack trace,..).
 * </p>
 * <p>
 * It also includes a collection of additional
 ...
 *
 * @author Li Weibo
 * @references 修改自topcoder的base-exception组件，http://www.topcoder.com
 */
