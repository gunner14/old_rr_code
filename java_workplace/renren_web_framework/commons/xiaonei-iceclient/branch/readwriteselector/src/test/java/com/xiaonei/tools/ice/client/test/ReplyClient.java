...
public class ReplyClient {
	...
	public static void main(String[] args) {
		if (args.length != 6) {
			System.out
					.println("Usage: ReplyClient <echo/delay> <ip> <port> <concurrent> <connections> <selector>");
			System.exit(1);
		}
		...
		com.xiaonei.tools.ice.client.IceClient client = new com.xiaonei.tools.ice.client.IceClient(address,connections,selectors);
