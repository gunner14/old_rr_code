...
public interface Catalogs {
    ...
    public static final String GOSSIP_NEW = XceAdapter.DB_GOSSIP_NEW;

    public static final String GOSSIP_INFO_NEW = XceAdapter.DB_GOSSIP_INFO_NEW;
    ...
    /** 世界杯活动 */
    public static final String WORLD_CUP_USER = XceAdapter.DB_WORLD_CUP_USER;

    public static final String WORLD_CUP_COUPLE = XceAdapter.DB_WORLD_CUP_COUPLE;

    public static final String USER_PASSPORT_INVITE = XceAdapter.DB_USER_PASSPORT_INVITE;

    /** 雪碧活动 */
    public static final String XUEBI = XceAdapter.DB_XUEBI;

    public static final String HOTORNOT = XceAdapter.DB_HOTORNOT;

    /** ASP 俱乐部 */
    public static final String ASP_ORG = XceAdapter.DB_ASP_ORG;
}
