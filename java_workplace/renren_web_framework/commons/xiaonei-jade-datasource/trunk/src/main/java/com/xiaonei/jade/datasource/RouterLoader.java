...
import com.xiaonei.jade.datasource.router.DateRouter;
import com.xiaonei.jade.datasource.router.DirectRouter;
import com.xiaonei.jade.datasource.router.HashRouter;
import com.xiaonei.jade.datasource.router.HexHashRouter;
import com.xiaonei.jade.datasource.router.RangeRouter;
import com.xiaonei.jade.datasource.router.RoundRouter;
import com.xiaonei.jade.datasource.router.StringHashCodeRouter;
        ...
        for (Element child : XMLUtils.getChildren(element)) {
            ...
            if (HASH.equalsIgnoreCase(child.getTagName())) {
                ...
                if (excludeNow == null || excludeNow.length() == 0) {
                    ...
                    return createDateRouter(column, pattern, partitions, Boolean
                            .valueOf(excludeNow));
                }
            } else {
                if (logger.isDebugEnabled()) {
