package com.xiaonei.jade.datasource.router;

import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import org.springframework.jdbc.BadSqlGrammarException;

import com.xiaonei.jade.datasource.Router;
...
public class HashRouter implements Router {
    ...
    public String doRoute(Object columnValue) {
        ...
        if (pattern != null && columnValue != null) {
            ...
            // MessageFormat.format在散10000份的时侯会有逗号的出现，比如“conversation_8,464"
            //            String name = MessageFormat.format(pattern, value);
            String name = pattern.replace("{0}", "" + value);
