...
public class Constants {
	...
	public static int TRAP_INTERVAL = 60*5;
	...
	public static final String TABLE_STORAGE_NODE = "storage_node";
	...
	public static int NODE_STATUS_TEMP_READABLE=4; //node 状态临时只读
