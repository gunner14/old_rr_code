...
public class SelectorTest {
	...
	public void init(){
		...
		Thread t = new Thread(selector,"acceptor thread");
		t.start();
	}
	...
	public void testHttp() throws IOException{
		...
		if(!socket.connect(new java.net.InetSocketAddress("www.baidu.com",80))){
			selector.register(socket, SelectionKey.OP_CONNECT, handler);
		}
