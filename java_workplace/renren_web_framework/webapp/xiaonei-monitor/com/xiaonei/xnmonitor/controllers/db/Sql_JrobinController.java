...
public class Sql_JrobinController {
    ...
    public String listBiz(Model model, @Param("dayType") String dayType,
        ...
        final File file = new File(Global.JROBIN_RESULT_DIR + Global.JRD_CHILD_DIR_DB + "/");
        ...
        String[] rrdFiles = file.list(new FilenameFilter() {
            ...
            public boolean accept(File dir, String name) {
                if (name.endsWith(".rrd") && !name.contains("127.0.0.1")) {
                    ...
                    return !UtilTools.isNaN(file.getAbsolutePath(), Global.DSNAME_DB, name, end,
                            start);
                    //                    					return true;
                } else {
                    return false;
        ...
        Arrays.sort(rrdFiles, new SortFile(file.getAbsolutePath(), end, UtilTools.getStartTime(
                dayType, end), Global.DSNAME_DB));
        //        int i = 0;
        //        for (String s : rrdFiles) {
        //            System.out.println(s + "<-------------ssssssssssss------------>:" + (i++));
        //        }
    ...
    public String listSql(Model model, @Param("dayType") String dayType,
        ...
        for (int i = 0; i < rrdFilesList.size();) {
            ...
            if (UtilTools.isNaN(filePath, Global.DSNAME_DB, rrdFilesList.get(i), end, start)) {
        ...
        //					return UtilTools.isNaN(filePath, Global.HTTP_DSNAME, name, end, start);
        //				} else {
        //					return false;
        //				}
        //			}
