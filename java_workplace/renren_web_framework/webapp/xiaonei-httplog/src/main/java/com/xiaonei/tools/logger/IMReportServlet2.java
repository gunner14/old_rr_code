...
public class IMReportServlet2 extends javax.servlet.http.HttpServlet {
	/**
	 * Only DNS and URL and remote host
	 */
	...
	private static final String DIR_PREFIX = "/data/httperror/im/";
