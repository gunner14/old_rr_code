...
@Service
public class PassportReturnListern implements IAfterLoginListern{
	...
	public LoginStatusCode process(HttpServletRequest request,
		...
		if(!StringUtils.isEmpty(result.getOldPassport())){
			resultWrapper.addResultContents(LoginResultCode.ELD_PASSPORT, result.getOldPassport());
		}
		resultWrapper.addResultContents(LoginResultCode.PASSPORT, result.getPassportTicket());
