 ...
 *
 */
@Path(value = { "ShowCaptcha2.do", "ShowCaptcha2", "showCaptcha2" })
@Singleton
@Ajax
public class CaptchaForDaqinController {
    ...
    public int isShowCaptcha(final Invocation inv,//
            @FormValidator(validateAllParams = true) final PassportForm pForm, @Param("ip")String ip) {
