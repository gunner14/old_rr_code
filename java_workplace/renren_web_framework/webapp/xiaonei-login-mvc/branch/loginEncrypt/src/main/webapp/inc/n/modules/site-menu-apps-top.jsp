	...
	<div class="apps-item" id="appsItem_${item.appId}">
		...
		<div class="item-editor">
			...
			<span class="editor-operations">
				...
				<c:if test="${!canNotDel}">
					<a href="#nogo" data-deluri="http://apps.renren.com/menu/removeTopApp" data-appid="${item.appId}" data-optype="del" data-pos="1" onclick="this.blur();return false;" class="an-operation">移除</a>
				</c:if>
			</span>
		</div>
	</div>
		...
		<div class="item-title">
			<span class="item-main">
				<a ${stats} href="${sideNavUrl}${sp}origin=${origin}"${target}<c:if test="${item.appId==60||item.appId==95003||item.appId==120019||item.appId==166607||item.appId==166613||item.appId==166614||item.appId==166615||item.appId==166616}"> ui-async="async"</c:if>>
					...
					${item.appName}
					<img src="http://a.xnimg.cn/imgpro/bg/app_top3.png" style="width: 15px; height: 12px;margin-left:2px;" title="推荐应用"/>
				</a>
			</span>
		</div>
		<div class="item-editor">
			...
			<span class="editor-operations">
				<a href="#nogo" data-appid="${item.appId}" data-optype="add" onclick="this.blur();return false;" class="an-operation">移动至常用</a>
				<c:if test="${!canNotDel}">
					<a href="#nogo" data-deluri="http://apps.renren.com/menu/removeTopApp" data-appid="${item.appId}" data-optype="del" data-pos="2" onclick="this.blur();return false;" class="an-operation">移除</a>
				</c:if>
			</span>
		</div>
	</div>
	...
	<div class="apps-item" id="appsItem_${item.appId}">
		...
		<div class="item-editor">
			...
			<span class="editor-operations">
				<a href="#nogo" data-appid="${item.appId}" data-optype="add" onclick="this.blur();return false;" class="an-operation">移动至常用</a>
				<c:if test="${!canNotDel}">
					<a href="#nogo" data-deluri="http://apps.renren.com/menu/removeTopApp" data-appid="${item.appId}" data-optype="del" data-pos="3" onclick="this.blur();return false;" class="an-operation">移除</a>
				</c:if>
			</span>
		</div>
	</div>
	...
	<div class="apps-item" id="appsItem_${item.appId}">
		...
		<div class="item-editor">
			...
			<span class="editor-operations">
				<a href="#nogo" data-appid="${item.appId}" data-optype="add" onclick="this.blur();return false;" class="an-operation">移动至常用</a>
				<c:if test="${!canNotDel}">
					<a href="#nogo" data-deluri="http://apps.renren.com/menu/removeTopApp" data-appid="${item.appId}" data-optype="del" data-pos="4" onclick="this.blur();return false;" class="an-operation">移除</a>
				</c:if>
			</span>
		</div>
	</div>
