...
<div class="site-menu-nav-box box">
	<article id="site-menu-nav" class="site-menu-apps">
		...
		<section class="site-menu-apps-base">
			<div class="apps-item">
				<div class="item-title">
					<span class="item-main"> <a href="${fn:escapeXml(home_url)}" ui-async="async"><img class="icon" src="${applicationScope.urlStatic}/imgpro/v6/icon/feed.png" /> 新鲜事</a>
					</span>
				</div>
			</div>
			<c:if test="${!host.page}">
		...
		<section class="site-menu-apps-favor">
			<%-- 收藏的应用 --%>
			<%@ include file="/inc/n/modules/site-menu-apps-fav.jsp" %>
		</section>
	...
	<article class="site-menu-apps" id="site-menu-apps-nav">
		<section class="site-menu-apps-others">
			<c:if test="${!host.page}">
				...
				<%-- 置顶应用 --%>
				<%@ include file="/inc/n/modules/site-menu-apps-top.jsp" %>
			...
			<%@ include file="/inc/n/modules/site-menu-apps-item2.jsp" %>
