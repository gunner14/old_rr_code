...
<body id="registerpage" class="login">
	...
	<div id="opi" class="page-wrapper clearfix">
		<div class="full-page-holder">
			...
			<a href="http://www.renren.com/renren/index.html" style="border:0; margin:0 auto; padding:0 0 10px; display:block; width:900px;" target="_blank"><img src="${applicationScope.urlStatic}/imgpro/login/xntrr.png?ver=$revxxx$"/></a>
			</c:if>
				<div class="login-page clearfix">
									...
									<form method="post" id="loginForm" action="${applicationScope.urlPassport}/PLogin.do" focus="email">
										...
										<div class="authcode" style="padding-left:85px">
											...
											<div class="authcode-text">
												...
												<input type="hidden" value="xxxx" name="key_id">
											</div>
										</div>
										</c:if>
										<p class="right">
											<span class="float-right"><a tabindex="5" href='http://safe.${applicationScope.domain}/findPass.do'>取回密码</a></span>
										...
										<p class="right">
										    <%
                                        		...
                                        		if(domain != null && domain.trim().length()>0){
                                        			domain = com.xiaonei.antispam.AntiSpamUtils.getInstance().htmlSecurityEscape(domain);
					...
					<div class="float-right" style="margin:60px 15px 0 0;"><img alt="人人网是一个真实的社交网络，联络你和你周围的朋友。" src="http://s.xnimg.cn/imgpro/login/show-new1.png" width="447" height="229" /></div>
						</c:when>
