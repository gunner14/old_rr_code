...
<link href="${applicationScope.urlSmallStatic}/mall/login/css/style.css?ver=$revxxx$" rel="stylesheet" type="text/css" media="all" />
...
<a class="login-weibo" target="_top" href="https://api.weibo.com/oauth2/authorize?client_id=2820124502&response_type=code&forcelogin=true&with_offical_account=1&redirect_uri=http://j.renren.com/connectlogin/sinaconfig">微博帐号登录</a>
<a class="login-qq" target="_top" href="https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=100298206&redirect_uri=j.renren.com/connectlogin/qqconfig">QQ帐号登录</a>
</div>
</body>
</html>
