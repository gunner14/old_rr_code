...
public abstract class Globals {
	 ...
	 public static final String RENREN_DOMAIN = "renren.com";
	    ...
	    public static final String PASSPORT_DOMAIN = "login.renren.com";
	    public static final String PASSPORT_DOMAIN_OLD = "renren.com";

	    public static final String PASSPORT_3RD_DOMAIN = PASSPORT_DOMAIN;
	    public static final String PASSPORT_3RD_DOMAIN_OLD = RENREN_DOMAIN;
	    
	    public static final String PASSPORT_APP_DOMAIN = "apps.renren.com";
	    public static final String PASSPORT_PAGE_DOMAIN = "page.renren.com";
