...
/**
 * {@link Entry} 代表一个可被信息聚合系统存储的对象，它由一个全局唯一的 ID 以及若干字段 {@link Field} 组成。
 * <p>
 * {@link Entry}是可扩展字段的，我们制定了一个“字段命名规范”，您在使用前一定要阅读这个Wiki： <a href="http://project.d.xiaonei.com/projects/infrastructure-entries/wiki/%E5%AD%97%E6%AE%B5%E5%91%BD%E5%90%8D%E8%A7%84%E8%8C%83"
 * >字段命名规范</a>
 * 
...
public class Entry implements Cloneable, Serializable{
    ...
    public Timestamp getTimestamp() {
        if (updated == 0) {
            throw new IllegalStateException("wrong updated value: " + updated);
        }
