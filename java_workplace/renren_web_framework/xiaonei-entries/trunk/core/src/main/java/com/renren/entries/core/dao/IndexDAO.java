...
public interface IndexDAO {
    ...
    public List<Hit> olderPage(String field, @ShardBy Object indexValue, Range<Long> entryRange,
    ...
    @SQL("SELECT id, entry_id FROM "
            ...
            + " WHERE index_value = :2 #if(:3){ AND entry_id BETWEEN :3.start AND :3.end} AND id > :4 ORDER BY id DESC LIMIT :5")
    @RowHandler(rowMapper = HitRowMapper.class)
    public List<Hit> newerPage(String field, @ShardBy Object indexValue, Range<Long> entryRange,
    ...
    @RowHandler(rowMapper = HitRowMapper.class)
    public List<Hit> olderPage(String field, @ShardBy Object indexValue, long upperCursor,
    ...
    @SQL("SELECT id, entry_id FROM " + TABLE_NAME
            + " WHERE index_value = :2  AND entry_id in (:4) AND id > :3 ORDER BY id DESC LIMIT :5")
    @RowHandler(rowMapper = HitRowMapper.class)
    public List<Hit> newerPage(String field, @ShardBy Object indexValue, long lowerCursor,
            long[] entries, int limit);
    ...
    @RowHandler(rowMapper = HitRowMapper.class)
    public List<Hit> rangePage(String field, @ShardBy Object indexValue, Range<Long> entryRange,
