...
// tag:(123 or 456 or 678)
  final public QField FieldExpression() throws ParseException {
  ...
  final public QValue FieldValueExpression() throws ParseException {
        QValue value = null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case FIELD_NUMBER_VALUES:
  ...
  final public QValue FieldNumberValuesExpression() throws ParseException {
  ...
  final public QValue FieldStringValueExpression() throws ParseException {
        QValue value = new QValue();
        Token t = null;
