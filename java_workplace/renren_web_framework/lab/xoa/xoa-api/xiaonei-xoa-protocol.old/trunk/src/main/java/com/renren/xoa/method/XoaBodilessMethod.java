 ...
 */
public abstract class XoaBodilessMethod extends XoaMethodBase {

	public XoaBodilessMethod(String domain, String path) {
		super(domain, path);
	}
	...
	public static void main(String[] args) {
		System.out.println(XoaMethodName.GET.toString());
	}
