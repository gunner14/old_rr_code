...
public class DefaultServiceFutrue<T> implements ServiceFuture<T> {
	...
	void setXoaClient(XoaClientI xoaClient) {
	...
	public void setResponse(XoaResponse response) {
	...
	public ServiceFuture<T> submit() {
		...
		invocationInfo = this.xoaClient.submit(method, new XoaResponseCallback() {
			@Override
