...
import com.renren.xoa.methods.XoaPostMethod;
...
public abstract class Method {
	...
	public static Method get(String url) {
		Method method = new XoaGetMethod();
	...
	public static Method put(String url) {
		...
		//解决put方法没有body的问题
		Method method = new XoaPostMethod();
		resolveUrl(url, method);
	...
	public static Method multiFormatPost(String url) {
        Method method = new XoaMultiFormatPostMethod();
        resolveUrl(url, method);
        return method;
    }
	
	public static Method delete(String url) {
		Method method = new XoaDeleteMethod();
		resolveUrl(url, method);
		return method;
	}
     ...
     */
    public abstract XoaMethodName getName();
