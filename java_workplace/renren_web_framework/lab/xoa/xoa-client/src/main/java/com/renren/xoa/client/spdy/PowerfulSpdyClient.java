package com.renren.xoa.client.spdy;
...
import com.renren.xoa.client.spdy.netty.XoaClientPipelineFactory;
...
public class PowerfulSpdyClient extends SimpleChannelUpstreamHandler implements SpdyClient {
    ...
    public void init() {
    	...
    	try {
            ...
            bootstrap.setPipelineFactory(new XoaClientPipelineFactory(this));
