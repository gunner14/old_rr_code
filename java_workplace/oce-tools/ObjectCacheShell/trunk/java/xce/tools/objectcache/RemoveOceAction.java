...
public class RemoveOceAction extends Consumer {
	...
	public RemoveOceAction(Producer producer, String endpoints, int[] categories,
			int cluster) {
		super(producer);
	...
	protected void consume(Long[] batch) {
		System.out.println("OceChannel Remove " + batch.length + " objects");
