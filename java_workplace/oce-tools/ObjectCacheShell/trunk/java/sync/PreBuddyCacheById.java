...
import xce.buddy.BuddyCacheByIdManagerPrx;
import xce.buddy.BuddyCacheByIdManagerPrxHelper;
...
public class PreBuddyCacheById {
...
public static void main(String[] args) {
        ...
        objects[0]=channel.getCommunicator().stringToProxy("M@BuddyCacheById0");
        objects[1]=channel.getCommunicator().stringToProxy("M@BuddyCacheById1");
        objects[2]=channel.getCommunicator().stringToProxy("M@BuddyCacheById2");
        objects[3]=channel.getCommunicator().stringToProxy("M@BuddyCacheById3");
        objects[4]=channel.getCommunicator().stringToProxy("M@BuddyCacheById4");
        objects[5]=channel.getCommunicator().stringToProxy("M@BuddyCacheById5");
        objects[6]=channel.getCommunicator().stringToProxy("M@BuddyCacheById6");
        objects[7]=channel.getCommunicator().stringToProxy("M@BuddyCacheById7");
        objects[8]=channel.getCommunicator().stringToProxy("M@BuddyCacheById8");
        objects[9]=channel.getCommunicator().stringToProxy("M@BuddyCacheById9");
        ...
        try {
            while (true) {
                    try {
                            ...
                            System.out.println("Load BuddyCacheById from "+id+" to "+max);
                            for(int i=0;i<10;i++){
                            ...
                            for(int i=0;i<10;i++){
                                ...
                                for(ObjectPrx p:proxies){
                                        BuddyCacheByIdManagerPrx ocp = BuddyCacheByIdManagerPrxHelper.uncheckedCast(p);
