#ifndef XCE_DBDESC_DESCRIPTOR_SLICE__
#define XCE_DBDESC_DESCRIPTOR_SLICE__
...
module xce
{
    ...
    bool update(string name, string action, DbInstance db);
	};
};
};
};
#endif // XCE_DBDESC_DESCRIPTOR_SLICE__
