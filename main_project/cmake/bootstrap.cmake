...
INCLUDE_DIRECTORIES( 
  ...
  ${XNS_ROOT_DIR}
	...
	${XNS_BUILD_DIR}/tmp/OceSlice/slice
	${XNS_BUILD_DIR}/tmp
	...
	#${XNS_ROOT_DIR}/third-party/thrift
	...
	"/usr/include/uuid"
	${XNS_ROOT_DIR}/third-party/libactivemq/include/activemq-cpp-3.4.1
	${XNS_BUILD_DIR}/tmp/OceProto/proto
...
LINK_DIRECTORIES( ${XNS_ROOT_DIR}/third-party/apr/lib /usr/lib64/nptl /usr/local/xce-dev/lib64 /usr/local/xce/lib64 /usr/local/xce/lib /opt/curl/lib ${XNS_ROOT_DIR}/depends/mysql++-3.0.6/	/opt/XiaoNei/mysqlpp_lib64/ 
  ...
  ~/lib/
	...
	#${XNS_ROOT_DIR}/third-party/thrift/lib
