...
public:
  ...
  virtual bool sessionExist(Ice::Long index, const Ice::Current& = Ice::Current());
  virtual DeliverStatList GetDeliverStat(const Ice::Current& = Ice::Current());
  virtual void ClearDeliverStat(const Ice::Current& = Ice::Current());

  virtual HeartBeatConfPtr getHeartBeatConf(const Ice::Current& = Ice::Current());
  virtual void setHeartBeatConf(const HeartBeatConfPtr &conf, const Ice::Current& = Ice::Current());
  virtual void opeHeartBeatThread(int flag, const Ice::Current& = Ice::Current());
