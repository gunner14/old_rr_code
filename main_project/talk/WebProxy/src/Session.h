...
protected:
	virtual void deliver(const SessionPtr& session, int status_code,
			...
			bool bin_data = false,
			const string& content_type = "text/html;charset=UTF-8", const string& nogzipmsg = "");
...
class CometRecvStat : public ConnectionStat, public Singleton<CometRecvStat> {
public:
	virtual void response(const RequestPtr& request, const SessionPtr& session);
protected:
	virtual void deliver(const SessionPtr& session, int status_code,
...
class CometResponseStat : public ConnectionStat,
	public Singleton<CometResponseStat> {
public:
...
class BroadcastResponseStat : public ConnectionStat,
	public Singleton<BroadcastResponseStat> {
public:
	virtual void response(const RequestPtr& request, const SessionPtr& session);
};
