...
public class FeedViewForTimelineHaAdapter extends ReplicatedClusterAdapter {
	...
	private FeedViewPrx getManager(int uid) {
        ...
        public List<String> getTimelineDataWithAdminByStypes(int ownerid, int uid, String name, int year, int month,
                        int render, int begin, int limit, boolean isAdmin, int[] stypes) {
                String[] html = null;
                FeedViewPrx prx = null;
                try {
                        prx = getManager(uid);
