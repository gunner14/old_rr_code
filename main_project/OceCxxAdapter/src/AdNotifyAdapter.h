...
#ifndef _AD_NOTIFY_ADAPTER_H_
#define _AD_NOTIFY_ADAPTER_H_
...
class AdNotifierAdapter: public MyUtil::AdapterI,
    public MyUtil::AdapterISingleton<MyUtil::NotifyChannel, AdNotifierAdapter> {
public:
  AdNotifierAdapter() {
