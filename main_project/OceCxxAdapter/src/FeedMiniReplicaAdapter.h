/*
 * FeedMiniReplicaAdapter.h
 *
 *  Created on: Oct 15, 2009
 *      Author: antonio
 */

#ifndef FEEDMINIREPLICAADAPTER_H_
#define FEEDMINIREPLICAADAPTER_H_
...
class FeedMiniReplicaAdapter: public MyUtil::ReplicatedClusterAdapterI<FeedItemManagerPrx>,
    public MyUtil::Singleton<FeedMiniReplicaAdapter> {
public:
  FeedMiniReplicaAdapter(): MyUtil::ReplicatedClusterAdapterI <FeedItemManagerPrx> ("ControllerFeedMiniR", 120, 300, new XceFeedChannel()) {
