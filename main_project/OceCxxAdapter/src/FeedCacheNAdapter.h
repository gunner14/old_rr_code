#ifndef FEED_CACHE_N_ADAPTER_H_
#define FEED_CACHE_N_ADAPTER_H_
...
class FeedCacheNAdapter : public AdapterI,
     public AdapterISingleton<MyUtil::XceFeedChannel, FeedCacheNAdapter>{
