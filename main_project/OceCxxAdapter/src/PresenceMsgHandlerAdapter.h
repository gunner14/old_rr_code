...
class PresenceMsgHandlerAdapter : public MyUtil::ReplicatedClusterAdapterI<PresenceHandlerPrx>, public MyUtil::Singleton<PresenceMsgHandlerAdapter> {
public:
	PresenceMsgHandlerAdapter()  : MyUtil::ReplicatedClusterAdapterI<PresenceHandlerPrx> ("ControllerPresenceMsgHandler",120,300,new TalkChannel) {
    /*
