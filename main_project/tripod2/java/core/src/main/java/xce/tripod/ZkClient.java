...
public class ZkClient {
    ...
    private ZkClient(String zkAddress) throws TripodException {
	this.zkAddress = zkAddress;
	initialize();
    }

    public static ZkClient getInstance(String zkAddress) throws TripodException {
    ...
    private boolean initialize() throws TripodException {
