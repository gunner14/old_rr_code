...
public interface CacheClient {
     ...
     * @throws TripodException 
     */
    List<String> getList(String key, int begin, int limit) throws TripodException;
     ...
     * @throws TripodException 
     */
    Map<String, String> getHash(String key, List<String> fields) throws TripodException;
     ...
     * @throws TripodException 
     */
    Map<String, String> getAllHash(String key) throws TripodException;
}
