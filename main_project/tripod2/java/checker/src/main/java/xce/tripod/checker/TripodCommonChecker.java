 ...
 * @date 2012-5-31
 */
public class TripodCommonChecker extends AbstractChecker {

  private static int EXPIRE_TIME = 3600 * 24 * 30;
	...
	public TripodCommonChecker(String namespace, String bizId) {
	...
	protected boolean reloadData(int id) {
		...
		try {
			boolean result = mCacheManagerProxy.load(String.valueOf(id), EXPIRE_TIME, true);
			return result;
		} catch (Exception e) {
			e.printStackTrace();
			return false;
	...
	public static void main(String[] args) {
		...
		TripodCommonChecker checker = new TripodCommonChecker(namespace, bizId);
