...
public interface EntryType {
    ...
    Entry BIZ_HOME_HIDFOOTPRINT = new Entry(NamespaceConstant.WEB_DEFAULT,
            BusinessConstant.BIZ_HOME_HIDFOOTPRINT);

    Entry BIZ_HOME_HOME = new Entry(NamespaceConstant.WEB_DEFAULT,
            BusinessConstant.BIZ_HOME_HOME);

    Entry BIZ_HOME_STARTOPLIST = new Entry(NamespaceConstant.WEB_DEFAULT,
            BusinessConstant.BIZ_HOME_STARTOPLIST );

    Entry BIZ_HOME_ALBUM = new Entry(NamespaceConstant.WEB_DEFAULT,
            BusinessConstant.BIZ_HOME_ALBUM);

    Entry BIZ_HOME_BLOG = new Entry(NamespaceConstant.WEB_DEFAULT,
            BusinessConstant.BIZ_HOME_BLOG);

    Entry BIZ_HOME_STATUS = new Entry(NamespaceConstant.WEB_DEFAULT,
            BusinessConstant.BIZ_HOME_STATUS);

    Entry BIZ_HOME_META_DESC= new Entry(NamespaceConstant.WEB_DEFAULT,
            BusinessConstant.BIZ_HOME_META_DESC);
    ...
    //开放平台
    Entry BIZ_PLATFORM_ACTIVITY = new Entry(NamespaceConstant.WEB_UGC,
            BusinessConstant.BIZ_PLATFORM_ACTIVITY);

    /** ugc voice 缓存 */
    Entry BIZ_VOICE = new Entry(NamespaceConstant.WEB_UGC, BusinessConstant.BIZ_VOICE);

    /** ugc voice 播放计数 */
    Entry BIZ_VOICE_COUNT = new Entry(NamespaceConstant.WEB_UGC, BusinessConstant.BIZ_VOICE_COUNT);

    /** ugc photo voice 播放计数 */
    Entry BIZ_PHOTO_VOICE_COUNT = new Entry(NamespaceConstant.WEB_UGC,
            BusinessConstant.BIZ_PHOTO_VOICE_COUNT);
    ...
    /** socialgraph推荐备份 */
    Entry BIZ_SOCIALGRAPH_RCD_BAK = new Entry(NamespaceConstant.AD_SOCIALGRAPH_BAK,
            BusinessConstant.BIZ_SOCIALGRAPH_RCD);

    Entry BIZ_SOCIALGRAPH_FOFLR_BAK = new Entry(NamespaceConstant.AD_SOCIALGRAPH_BAK,
            BusinessConstant.BIZ_SOCIALGRAPH_FOFLR);
    ...
    Entry BIZ_SOCIALGRAPH_RCD_FRIEND_BR = new Entry(NamespaceConstant.SOCIALGRAPH_COMMON,
            BusinessConstant.BIZ_SOCIALGRAPH_RCD_FRIEND_BR);

    /** 相册推荐 */
    Entry BIZ_SOCIALGRAPH_PHOTO_RECOMMEND = new Entry(NamespaceConstant.SOCIALGRAPH_COMMON,
            BusinessConstant.BIZ_SOCIALGRAPH_PHOTO_RECOMMEND);
    ...
    Entry BIZ_SOCIALGRAPH_FRIEND_CLUSTER = new Entry(NamespaceConstant.SOCIALGRAPH_FFUCR,
            BusinessConstant.BIZ_SOCIALGRAPH_FRIEND_CLUSTER);
    ...
    /** 相册过往的今天，新鲜事屏蔽 */
    Entry BIZ_PTP_FEED_FILTER = new Entry(NamespaceConstant.WEB_UGC,
            BusinessConstant.BIZ_PTP_FEED_FILTER);
    ...
    Entry BIZ_ZHAN_USER_NICKNAME = new Entry(NamespaceConstant.WEB_ZHAN,
            BusinessConstant.BIZ_ZHAN_USER_NICKNAME);

    Entry BIZ_ZHAN_SUGGEST_FSITE= new Entry(NamespaceConstant.WEB_ZHAN,
            BusinessConstant.BIZ_ZHAN_SUGGEST_FSITE);

    Entry BIZ_ZHAN_VISITE_SITE = new Entry(NamespaceConstant.WEB_ZHAN,
            BusinessConstant.BIZ_ZHAN_VISITE_SITE);
    /** 小站 结束 */
    ...
    /** ntc新技术中心开始 */
    Entry BIZ_NTC_USER = new Entry(NamespaceConstant.NTC, BusinessConstant.BIZ_NTC_USER);

    Entry BIZ_NTC_FEED = new Entry(NamespaceConstant.NTC, BusinessConstant.BIZ_NTC_FEED);

    Entry BIZ_NTC_BAN = new Entry(NamespaceConstant.NTC, BusinessConstant.BIZ_NTC_BAN);

    Entry BIZ_NTC_LBS = new Entry(NamespaceConstant.NTC, BusinessConstant.BIZ_NTC_LBS);

    Entry BIZ_NTC_HOT = new Entry(NamespaceConstant.NTC, BusinessConstant.BIZ_NTC_HOT);

    Entry BIZ_NTC_COUNT = new Entry(NamespaceConstant.NTC, BusinessConstant.BIZ_NTC_COUNT);
