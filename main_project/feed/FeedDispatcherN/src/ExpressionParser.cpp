...
void AppFactor::Plus(set<int> & result) {
  if ( !DegradeManager::instance().IsEnable("FeedDispatcher::module_AppExpr") ) {
    return;
  }
...
void AppFanFactor::Plus(set<int> & result) {
  if ( !DegradeManager::instance().IsEnable("FeedDispatcher::module_AppFansExpr") ) {
    return;
  }
  string head = GenerateSQL();
  Statement sql;
...
void PageFactor::Plus(set<int> & result) {
  if ( !DegradeManager::instance().IsEnable("FeedDispatcher::module_PageExpr") ) {
    return;
  }
  string head = GenerateSQL();
  Statement sql;
...
void MiniGroupFactor::Plus(set<int> & result) {
  if ( !DegradeManager::instance().IsEnable("FeedDispatcher::module_MiniGroupExpr") ) {
    return;
  }
  string head = GenerateSQL();
  Statement sql;
...
void XiaoZuFactor::Plus(set<int> & result) {
  if ( !DegradeManager::instance().IsEnable("FeedDispatcher::module_XiaoZuExpr") ) {
    return;
  }
  string head = GenerateSQL();
  Statement sql;
...
void MiniSiteFactor::Plus(set<int> & result) {
  ...
  if ( !DegradeManager::instance().IsEnable("FeedDispatcher::module_MiniSiteExpr") ) {
    return;
  }
...
void CheWenFactor::Plus(set<int> & result) {
  ...
  if ( !DegradeManager::instance().IsEnable("FeedDispatcher::module_CheWenExpr") ) {
    return;
  }
...
void TagFactor::Plus(set<int> & result) {
  ...
  if ( !DegradeManager::instance().IsEnable("FeedDispatcher::module_MiniSiteTagExpr") ) {
    return;
  }
  do {
...
void GuangJieFactor::Plus(set<int> & result) {
  ...
  if ( !DegradeManager::instance().IsEnable("FeedDispatcher::module_GuangJieExpr") ) {
    return;
  }
  do {
    try{
