...
public class MyJob extends Configured implements Tool {
	...
	public static class MapClass extends
		...
		BloomFilter filter = new BloomFilter(100,4,Hash.JENKINS_HASH  );
		Context ctx = null;
...
//				context.write(key, val);
		...
		protected void cleanup(Reducer.Context context) throws IOException  {
			System.out.println("Reduce CLOSE WW");
			
			Path file = new Path(context.getConfiguration().get("mapred.output.dir") + "/mybloomfilter");			
