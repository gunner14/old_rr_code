...
const int ITEM_COUNT_LIMIT = INT_MAX;
...
public:
	...
	virtual FeedMetaSeq getByTypesWithFilterSimple(const IntSeq& userIds, ::Ice::Int begin, ::Ice::Int limit, const IntSeq& types, const StrSeq& filter, const ::Ice::Current& = ::Ice::Current());
	...
	virtual FeedMetaSeq getBiggerThanFeedidByTypesWithFilterSimple(const IntSeq& userIds, ::Ice::Long feedid, ::Ice::Int limit, const IntSeq& types, const StrSeq& filter, const ::Ice::Current& = ::Ice::Current());

  virtual FeedMetaSeq getBiggerThanFeedid(const IntSeq& userids, ::Ice::Long feedid, ::Ice::Int begin, ::Ice::Int limit, const IntSeq& types, const StrSeq& filter, const ::Ice::Current& = ::Ice::Current());
  virtual FeedMetaSeq getBiggerThanFeedidSimple(const IntSeq& userids, ::Ice::Long feedid, ::Ice::Int begin, ::Ice::Int limit, const IntSeq& types, const StrSeq& filter, const ::Ice::Current& = ::Ice::Current()); //此函数begin和limit作用与每个好友列表，不是作用于结果集。
...
private:
	...
	FeedMetaSeq getSegmentSimple(const std::vector< std::vector<FeedMetaData> >& data, int begin, int limit);
