...
enum WeiredSource {
  ...
  WS_TIMELINE = 0x200000,
  WS_PAGEFEED = 0x400000,
  WS_GUIDEFEED = 0x800000,
  WS_FRIENDORIGINAL = 0x1000000,
};
/*
// 业务类别不同，模板不同 = template_index
// 使用枚举能防止错误,不要强转
...
bool ExpandFeedXml(const feed::FeedData * feed, FeedXml * fx
            ...
            , bool isAdmin = false);
*/
static FeedXml emptyFeedXml;
static vector<ilikeit::LikeInfo*> emptyLikeInfoVec;
