...
FeedItemSeq   FeedCacheLogicI::get(int userId, int begin, int limit,  const Ice::Current& current) {
  ...
  float timeuse=1000000*(end.tv_sec-beg.tv_sec)+end.tv_usec-beg.tv_usec;
  timeuse/=1000;
  MCE_INFO("FeedCacheLogicI::get --> get FeedItemWrapper time:" << timeuse << "userId:" << userId << "  begin:" << begin << " limit" << limit);
...
void    FeedCacheLogicI::put(const FeedItem& item, const MyUtil::Int2IntMap& usersWeight, bool syncFeedDB, const Ice::Current&) {
  ...
  try{
    ...
    MCE_WARN("FeedCacheLogicI::put --> FeedCacheNReplicaAapter expception.  feedid:" << item.feed << " "  << e);
  }catch(std::exception& e) {
    MCE_WARN("FeedCacheLogicI::put --> FeedCacheNReplicaAapter exception. feedid:" << item.feed <<  " exception:" << e.what());
  }catch(...) {
    MCE_WARN("FeedCacheLogicI::put --> FeedCacheNReplicaAapter exception. feedid:" << item.feed <<  " unknown exception!");
  }
...
void    FeedCacheLogicI::remove(int userId, Ice::Long feedId, bool syncFeedDB, const Ice::Current&) {
  ...
  try{
    ...
    MCE_WARN("FeedCacheLogicI::removeMergeByFeedId --> FeedCacheNReplicaAdapter err, " << e);
  }catch(std::exception& e) {
    MCE_WARN("FeedCacheLogicI::removeMergeByFeedId --> FeedCacheNReplicaAdapter exception! userId:" << userId << " feedId:" << feedId << " syncFeedDB" << syncFeedDB << " exception:" << e.what());
  }catch(...) {
    MCE_WARN("FeedCacheLogicI::removeMergeByFeedId --> FeedCacheNReplicaAdapter exception! userId:" << userId << " feedId:" << feedId << " syncFeedDB" << syncFeedDB << " unknown exception!");
  }
...
void    FeedCacheLogicI::removeAll(int userId, bool syncFeedDB, const Ice::Current&) {
  ...
  try {
    ...
    MCE_WARN("FeedCacheLogicI::removeAll --> FeedCacheNReplicaAdapter err, " << e);
  }catch(std::exception& e) {
    MCE_WARN("FeedCacheLogicI::removeAll --> FeedCacheNReplicaAdapter exception! userId:" << userId << " syncFeedDB" << syncFeedDB << " exception:" << e.what());
  }catch(...) {
    MCE_WARN("FeedCacheLogicI::removeAll --> FeedCacheNReplicaAdapter exception! userId:" << userId << " syncFeedDB" << syncFeedDB << " unknown exception!");
  }
...
void  FeedCacheLogicI::removeByMerge(int userId, long merge, int stype, bool syncFeedDB,  const Ice::Current&) {
  ...
  try{
    ...
    MCE_WARN("FeedCacheLogicI::removeByMerge --> FeedCacheNReplicaAdapter err, " << e);
  }catch(std::exception& e) {
    MCE_WARN("FeedCacheLogicI::removeByMerge --> FeedCacheNReplicaAdapter exception! userId:" << userId << " syncFeedDB" << syncFeedDB << " exception:" << e.what());
  }catch(...) {
    MCE_WARN("FeedCacheLogicI::removeByMerge --> FeedCacheNReplicaAdapter exception! userId:" << userId << " syncFeedDB" << syncFeedDB << " unknown exception!");
  }
