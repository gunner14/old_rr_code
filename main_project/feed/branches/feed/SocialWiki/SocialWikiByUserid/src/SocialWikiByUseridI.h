...
public:
	LoadWikiFeedTask(int wikiid, int userid, UserWikiFeed & src, SocialWikiItemSeq * seq = NULL) : Task(TASK_LEVEL_SOCIAL_WIKI), userwiki_(src), wikiid_(wikiid), userid_(userid), pSeq_(seq) {
	}
	~LoadWikiFeedTask() {}
