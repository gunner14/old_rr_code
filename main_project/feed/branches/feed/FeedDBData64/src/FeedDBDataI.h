...
*/
  ...
  void			put64(const FeedItem& feed, const BlockInfo64Ptr& blkInfo, const Ice::Current& = Ice::Current());
	void			modify64(const FeedItem& feed, const BlockInfo64Ptr& blkInfo, const Ice::Current& = Ice::Current());
	void			putBatch64(const FeedItem& feed, const BlockInfo64Seq& blkInfoSeq, const Ice::Current& = Ice::Current());	
	void			putBatchBinary64(const FeedItem& feed, const string& data, const Ice::Current& = Ice::Current());	
	FeedItemSeq 	get64(const BlockInfo64Ptr& blkInfo, int begin, int count, const Ice::Current& = Ice::Current());
	FileInfoPtr		queryFile64(int fileId, const Ice::Current& = Ice::Current());
	ServiceInfoPtr		QueryServiceInfo64(const Ice::Current& = Ice::Current());
	void			deleteFile64(int fileId, const Ice::Current& = Ice::Current());
	bool			moveBlock64(const BlockInfo64Ptr& blkInfoFrom, const BlockInfo64Ptr& blkInfoTo, const Ice::Current& = Ice::Current());
	void			removeFeed64(const BlockInfo64Ptr& blkInfo, Ice::Long feedId, const Ice::Current& = Ice::Current());
	void			updateConfig64(const map<string, string>& cfgs, const Ice::Current& = Ice::Current());
