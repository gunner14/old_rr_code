#ifndef XCE_FEED_FOCUS_COUNT_ACTION_H__
#define XCE_FEED_FOCUS_COUNT_ACTION_H__
...
struct FeedFocusCountAction : public cwf::BaseAction {
...
#endif // XCE_FEED_FOCUS_COUNT_ACTION_H__
