...
class FeedCreatorI: public FeedCreator , public MyUtil::Singleton<FeedCreatorI> {
public:
...
//	FeedSeedPtr BuildFeedSeed(int stype, int version, const MyUtil::Str2StrMap& props);
	...
	set<string> DataSchema2Map(const string& schema);
	void XML2Map(pugi::xml_node node,string key, set<string>& result);
