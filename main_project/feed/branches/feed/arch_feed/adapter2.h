...
#include "feed/base_feed/rwlock.h"
#include "ReplicaCluster.h" // 支持usercache等模式
...
struct GridFeed {
  static Grid DefaultGrid() {
    ...
    //static Grid grid_("XceFeed/Locator:default -h 10.3.19.218 -p 14300:default -h XceFeedRegistryReplica1 -p 14301:default -h XceFeedRegistryReplica2 -p 14302");
    //static Grid grid_("XceFeed/Locator:default -h f55.xce.d.xiaonei.com -p 14300:default -h XceFeedRegistryReplica1 -p 14301:default -h XceFeedRegistryReplica2 -p 14302");
    return grid_;
  }
};
...
struct AdapterBase {
  ...
  static Prx Create(const Grid& grid, const char* endpoint) {
    Ice::ObjectPrx base = grid.c_->stringToProxy(endpoint)->ice_timeout(180);
...
struct Adapter : public AdapterBase<Adapter> {
  ...
  typedef AdapterBase<GridFeedSchool> feedschool;
