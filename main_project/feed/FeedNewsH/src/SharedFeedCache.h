...
public:
  ...
  void AddFeedReply(long fid, int reply);
...
public:
	...
	SharedFeed* GetRawPtr() const {return raw_ptr_;}
...
class InteractionDownloader: public MyUtil::Timer, public Singleton<InteractionDownloader> {
public:
