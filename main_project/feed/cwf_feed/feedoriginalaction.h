#ifndef XCE_FEED_ORIGINAL_ACTION_H__
#define XCE_FEED_ORIGINAL_ACTION_H__
...
struct FeedOriginalAction : public cwf::BaseAction {
...
#endif // XCE_FEED_ORIGINAL_ACTION_H__
