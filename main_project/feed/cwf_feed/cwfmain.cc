...
int main(int argc, char* argv[]) {
  ...
  while (-1 != (o = getopt(argc, argv, "a:d:F:M:p:t:s:?hT"))) {
    switch(o) {
...
//    case 'v': show_version(); return 0;
  ...
  MCE_INIT(stem.str(), "INFO");
  com::xiaonei::xce::ConnectionPoolManager::instance().initialize();
  xce::CwfStatLog::instance().initLogger();
  return cwf::FastcgiMain(thread_count);
}
