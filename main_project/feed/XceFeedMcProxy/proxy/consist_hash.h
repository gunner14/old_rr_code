#ifndef _FEED_NEW_XCE_CONSIST_HASH_H_
#define _FEED_NEW_XCE_CONSIST_HASH_H_
...
private:
  ...
  typedef std::vector<CachePoint> CachePointSeq;
  CachePointSeq cache_points_;
...
#endif //_FEED_NEW_XCE_CONSIST_HASH_H_
