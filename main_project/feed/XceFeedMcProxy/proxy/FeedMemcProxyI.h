#ifndef _FEED_NEW_XCE_FEED_MEMC_PROXY_
#define _FEED_NEW_XCE_FEED_MEMC_PROXY_
...
//class FeedMemcProxyI : public FeedMemcachedProxy, public Singleton<FeedMemcProxyI> {
public:
...
#endif // _FEED_NEW_XCE_FEED_MEMC_PROXY_
