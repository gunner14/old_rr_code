...
public:
  ...
  vector<T> getValidProxySeqOneway(long mod) {
		return _clientCS.getValidProxySeqOneway(mod);
  }

  vector<T> getInvalidProxySeqOneway(long mod) {
		return _clientCS.getInvalidProxySeqOneway(mod);
  }
