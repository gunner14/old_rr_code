...
//新鲜事log服务集群Channel
FeedLogChannel::FeedLogChannel() {
  Ice::PropertiesPtr properties = Ice::createProperties();
	properties->setProperty("Ice.Override.ConnectTimeout", "300");
  properties->setProperty("IceGrid.InstanceName", "FeedLog");
  properties->setProperty("Ice.ThreadPool.Client.StackSize", "65535");
  properties->setProperty("Ice.ThreadPool.Server.StackSize", "65535");
  properties->setProperty("Ice.Default.Host", IpAddr::inner());
  properties->setProperty(
				"Ice.Default.Locator",
				"FeedLog/Locator:default -h FeedLogRegistry -p 14300");
	Ice::InitializationData id;
	id.properties = properties;
	_communicator = Ice::initialize(id);
  _query = IceGrid::QueryPrx::uncheckedCast(_communicator->stringToProxy("FeedLog/Query"));
}
...
//---------------------------------------------------------------------------
//XceFeedMcProxy
XceFeedMcProxyChannel::XceFeedMcProxyChannel() {
        Ice::PropertiesPtr properties = Ice::createProperties();
        properties->setProperty("Ice.Override.ConnectTimeout", "300");
        properties->setProperty("IceGrid.InstanceName", "XceFeedMcProxy");
        ...
        properties->setProperty(
                "Ice.Default.Locator",
                "XceFeedMcProxy/Locator:default -h XceFeedMcProxyRegistry -p 14800:default -h XceFeedMcProxyRegistryReplica1 -p 14801:defaut -h XceFeedMcProxyRegistryReplica2 -p 14802");
        Ice::InitializationData id;
        id.properties = properties;
        _communicator = Ice::initialize(id);

        _query
                = IceGrid::QueryPrx::uncheckedCast(_communicator->stringToProxy("XceFeedMcProxy/Query"));
...
TriggerChannel::TriggerChannel(){
        Ice::PropertiesPtr properties = Ice::createProperties();
        properties->setProperty("Ice.Override.ConnectTimeout", "300");
        properties->setProperty("IceGrid.InstanceName", "Trigger");
	...
	properties->setProperty("Ice.MessageSizeMax", "20480");
        ...
        properties->setProperty(
                "Ice.Default.Locator",
                "Trigger/Locator:default -h TriggerRegistry -p 14860:default -h TriggerRegistryReplica1 -p 14861:default -h TriggerRegistryReplica2 -p 14862");
        ...
        _query
                = IceGrid::QueryPrx::uncheckedCast(_communicator->stringToProxy("Trigger/Query"));
}
...
AdMobChannel::AdMobChannel(){
        Ice::PropertiesPtr properties = Ice::createProperties();
        properties->setProperty("Ice.Override.ConnectTimeout", "300");
        properties->setProperty("IceGrid.InstanceName", "AdMob");
        ...
        properties->setProperty(
          "Ice.Default.Locator",
          "AdMob/Locator:default -h AdMobRegistry -p 14880:default -h AdMobRegistryReplica1 -p 14881:default -h AdMobRegistryReplica2 -p 14882");
        Ice::InitializationData id;
        id.properties = properties;
        _communicator = Ice::initialize(id);

        _query
                = IceGrid::QueryPrx::uncheckedCast(_communicator->stringToProxy("AdMob/Query"));
}
...
//------------------------------------------------------------------------
//AdMonitorChannel
AdMonitorChannel::AdMonitorChannel(){
        Ice::PropertiesPtr properties = Ice::createProperties();
        properties->setProperty("Ice.Override.ConnectTimeout", "300");
        properties->setProperty("IceGrid.InstanceName", "AdMonitor");
    ...
    properties->setProperty("Ice.MessageSizeMax", "20480");
        ...
        properties->setProperty(
          "Ice.Default.Locator",
          "AdMonitor/Locator:default -h AdMonitorRegistry -p 14890:default -h AdMonitorRegistryReplica1 -p 14891:default -h AdMonitorRegistryReplica2 -p 14892");
        Ice::InitializationData id;
        id.properties = properties;
        _communicator = Ice::initialize(id);

        _query
                = IceGrid::QueryPrx::uncheckedCast(_communicator->stringToProxy("AdMonitor/Query"));
}
...
SearchChannel::SearchChannel(){
    ...
    //properties->setProperty("Ice.Default.Locator", "TestXiaoNeiSearch/Locator:tcp -h 10.3.21.189 -p 4094");
    Ice::InitializationData id;
    id.properties = properties;
    _communicator = Ice::initialize(id);

    _query = IceGrid::QueryPrx::uncheckedCast(_communicator->stringToProxy("XiaoNeiSearch/Query"));
    //_query = IceGrid::QueryPrx::uncheckedCast(_communicator->stringToProxy("TestXiaoNeiSearch/Query"));
}
...
//---------------------------------------------------------------------------
SearchControllerChannel::SearchControllerChannel(){
        Ice::PropertiesPtr properties = Ice::createProperties();
        //properties->setProperty("Ice.Override.Timeout", "300");
        properties->setProperty("Ice.Override.ConnectTimeout", "300");
        properties->setProperty("IceGrid.InstanceName", "XiaoNeiSearch");
        ...
        properties->setProperty("Ice.Default.Locator", "XiaoNeiSearchController/Locator:default -h XiaoNeiSearchControllerRegistry -p 4098:default -h XiaoNeiSearchRegistryControllerReplica1 -p 4098:default -h XiaoNeiSearchRegistryControllerReplica2 -p 4098");
        Ice::InitializationData id;
        id.properties = properties;
        _communicator = Ice::initialize(id);

        _query = IceGrid::QueryPrx::uncheckedCast(_communicator->stringToProxy("XiaoNeiSearchController/Query"));
}
...
//---------------------------------------------------------------------------
ScoreNewChannel::ScoreNewChannel(){
	Ice::PropertiesPtr properties = Ice::createProperties();
	properties->setProperty("Ice.Override.ConnectTimeout", "300");
	...
	properties->setProperty("Ice.Default.Locator", "ScoreNew/Locator:default -h ScoreNewMaster -p 4070:default -h ScoreNewReplica1 -p 4070:default -h ScoreNewReplica2 -p 4070");

	Ice::InitializationData id;
        id.properties = properties;
        _communicator = Ice::initialize(id);

        _query = IceGrid::QueryPrx::uncheckedCast(_communicator->stringToProxy("ScoreNew/Query"));
}
