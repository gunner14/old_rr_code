...
//---------------------------------------------------------------------------
class SearchControllerChannel : public Channel {
public:
	SearchControllerChannel();
	virtual ~SearchControllerChannel();
};
//---------------------------------------------------------------------------
...
class XceFeedF87Channel : public Channel {
public:
	XceFeedF87Channel();
	virtual ~XceFeedF87Channel();
};
...
//新鲜事log服务集群channel
class FeedLogChannel : public Channel {
public:
  FeedLogChannel();
  virtual ~FeedLogChannel();
};
...
//新鲜事 proxy 集群 channel
class XceFeedMcProxyChannel : public Channel {
public:
  XceFeedMcProxyChannel();
  virtual ~XceFeedMcProxyChannel();
};
...
class TriggerChannel : public Channel {
public:
  TriggerChannel();
  virtual ~TriggerChannel();
};
...
class AdMobChannel : public Channel {
public:
  AdMobChannel();
  virtual ~AdMobChannel();
};

class AdMonitorChannel : public Channel {
public:
  AdMonitorChannel();
  virtual ~AdMonitorChannel();
};
...
//---------------------------------------------------------------------------
class ScoreNewChannel : public Channel {
public:
	ScoreNewChannel();
	virtual ~ScoreNewChannel();
};
//---------------------------------------------------------------------------
