...
Ice.loadSlice("-I../UtilSlice/slice -I../OceSlice/slice --all ../UtilSlice/slice/Util.ice ../UtilSlice/slice/ObjectCache.ice ../OceSlice/slice/User.ice ../OceSlice/slice/UserConfig.ice ../OceSlice/slice/CountCache.ice")
import MyUtil
...
try:
    ...
    for i in range(0, 10):
        ...
        users.append( mop.hi.svc.count.CountManagerPrx.checkedCast(ic.stringToProxy("MANAGER@CountCacheN" + str(i)).ice_timeout(10)) )
    #uid=int(200353733)
    #users[uid % 10].reloadUser(200353733)
    f = file("preloadCountCache.txt")
    while True:
        line = f.readline()
        if len(line) == 0:
            break
