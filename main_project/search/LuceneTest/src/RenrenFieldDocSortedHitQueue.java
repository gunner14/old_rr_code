 ...
 * @since lucene 1.4
 */
class RenrenFieldDocSortedHitQueue extends PriorityQueue<FieldDoc> {
	 ...
	 */
	RenrenFieldDocSortedHitQueue(int size) {
		initialize(size);
	}

	/**
	 * Allows redefinition of sort fields if they are <code>null</code>. This is
	 * to handle the case using ParallelMultiSearcher where the original list
	 * contains AUTO and we don't know the actual sort type until the values
	 * come back. The fields can only be set once. This method should be
