 ...
 **/
public class InterestsProcessor {
	...
	public static void main(String args[]) {
		...
		innerMap.put("interests", "篮球");
		innerMap.put("interests", "足球");
		outerMap.put("interests", innerMap);
		List<Query> queryAll = InterestsProcessor.process(outerMap, 2.0f);
