...
std::wstring normalize(const std::wstring &ws, uint32_t opt);
std::string normalize(const std::string &s, uint32_t opt = OPT_ALPHA|OPT_NUMBER|OPT_CHINESE|OPT_UPPTOLOW);
