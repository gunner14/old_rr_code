...
private:
  ...
  void ShowIndexSize();
  void FilterGroupsByDeviceType(set<AdGroupPtr>& selected, const HandlerPara::DeviceType device_type);
  inline bool CheckGroupByDeviceType(AdGroupPtr ad, const HandlerPara::DeviceType device_type);
private:
