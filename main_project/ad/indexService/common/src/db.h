	...
	namespace ad{
        ...
        void setConfigDBSource(const std::string &config_db_source){
          config_db_source_ = config_db_source;
				...
				{
          ad_db_source_ads_ = ad_db_source;
				}

        void setDBSource_Main(const std::string &ad_db_source)
        {
          ad_db_source_main_ = ad_db_source;
        }

				void outputDBConfig();

				int loadAdMembers(std::map<long, AdMemberPtr> &member_pool);
        ...
        std::string ad_db_source_ads_;
        std::string ad_db_source_main_;
