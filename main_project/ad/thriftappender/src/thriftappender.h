...
#ifndef _LOG4CPLUS_THRIFT_APPENDER_HEADER_
#define _LOG4CPLUS_THRIFT_APPENDER_HEADER_
...
namespace log4cplus {
     ...
     * </dl>
     */
    class LOG4CPLUS_EXPORT ThriftAppender : public Appender {
    public:
      // Ctors
        ThriftAppender(const log4cplus::tstring& host, int port, 
                       const log4cplus::tstring& serverName = tstring());
        ThriftAppender(const log4cplus::helpers::Properties & properties);
...
/*
        ...
        {
        public:
            ConnectorThread (ThriftAppender &);
...
*/
    ...
    private:
      // Disallow copying of instances of this class
        ThriftAppender(const ThriftAppender&);
        ThriftAppender& operator=(const ThriftAppender&);
    };
...
#endif // _LOG4CPLUS_THRIFT_APPENDER_HEADER_
