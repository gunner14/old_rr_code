...
public:
  ...
  void PushDefault(int uid, const string & ip, const string & referer, AdResultMap * ad_result_map) const;
  void Get(const AdResultMap & ads, string * html) const;
  void GetHtml(const string & referer, const AdResultMap & ads, string & html) const;  // for 3G
