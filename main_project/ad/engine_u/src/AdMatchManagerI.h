...
public:
  ...
  int trigger(const AdZoneDict &zone_dict, const UserProfile &profile, MatchHandlerParamter &para);
...
virtual AdResultMap GetAdsTest(::Ice::Int uid, ::Ice::Int stage,
    ...
    ::Ice::Int count, const ::std::string& referer, ::Ice::Int rotateindex, const Ice::Current& current = Ice::Current());

virtual AdZone2Creatives GetTriggerAds(::Ice::Int uid, ::Ice::Int stage,::Ice::Int gender,
    ::Ice::Int age, const ::std::string& currentArea, const ::std::string& ipArea, ::Ice::Long school,
    ::Ice::Int grade, const ZoneInfoMap& zones, const Ice::Current& current = Ice::Current()); 
...
private:
	void InitialPara(MatchHandlerParamter & para,const AdZonePtr& adzone,const ZoneInfoMap &zone_info_map);
