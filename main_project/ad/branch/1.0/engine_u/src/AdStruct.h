...
public:
  ...
  set<AdGroupPtr> GetDefaultGroupsForSA(int count);
...
public:
  ...
  double GetAdCtrFeatureWeight(){
    return adctr_feature_weight_;
  }
  void SetAdCtrFeatureWeight(double adctr_feature_weight){
    adctr_feature_weight_ = adctr_feature_weight;
  }
  hash_map<int, string> GetAdCtrFeatureData(){
    IceUtil::RWRecMutex::RLock lock(mutex_);
    return adctr_feature_data_;
  }
  void SetAdCtrFeatureData(hash_map<int, string> &adctr_feature_data){
    IceUtil::RWRecMutex::WLock lock(mutex_);
    adctr_feature_data_ = adctr_feature_data;
  }
private:
  IceUtil::RWRecMutex mutex_;
  ...
  hash_map<int, string> adctr_feature_data_;
  double adctr_feature_weight_;
