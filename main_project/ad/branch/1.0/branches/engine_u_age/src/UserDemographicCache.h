...
public:
  pair<double,int> GetUserAdGroupsCtr(const UserProfile & user_profile, Ice::Long zone_id ,int pos_id, Ice::Long group_id,Ice::Long sponsor_id);
  void Load();
private:
  ...
  double GetTwoFeatureCtr(Ice::Long zone_id, Ice::Long sponserID, Ice::Long adGroupID, int pos ,int gender,int stage);

  pair<double,int> GetDemoCtr(Ice::Long zone_id,Ice::Long sponserID,  Ice::Long adGroupID, int pos, int gender,int stage, int uid);

  void MY_MCE_DEBUG(Ice::Long zone_id, Ice::Long sp_id ,Ice::Long group_id,int pos ,int gender,int stage, double ctr, int uid, int state);
  ...
  double GetCtr(Ice::Long zone_id, Ice::Long sp_id ,Ice::Long group_id,int pos ,int gender,int stage){
