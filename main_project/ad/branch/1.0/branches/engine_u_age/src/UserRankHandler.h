...
public:
  ...
  SelectedAdGroupSeq GetZoneGroups3(const UserProfile & user_profile, long adzone, int count);
  AdGroupPtr GetZonePosFreshGroup(int userid, FreshAdQualityMap & fresh_groups, set<AdGroupPtr>& bid_ids, set<AdGroupPtr>& selected_ids, long adzone, int pos);
