...
string ConfigureModel::member_name() {
  return member_name_;
}
void ConfigureModel::set_member_name(string member_name) {
...
std::string ConfigureModel::ToString() {
 ...
 std::string OrientMarryInfo::member_name() {
  return member_name_;
}
 void OrientMarryInfo::set_member_name(std::string member_name) {
  member_name_ = member_name;
}
