...
void CreateAddInterestRecordData(const std::string& src, const std::string& des);
...
int main(int argc, char* argv[]) {
	...
	string source = "/data/xce/Project/hotfeedrecommend/add_visit_record/VisitRecordData";
	string destination = "/data/xce/Project/hotfeedrecommend/add_user_interest/UserInterestData";
	
	CreateAddInterestRecordData(source, destination);
