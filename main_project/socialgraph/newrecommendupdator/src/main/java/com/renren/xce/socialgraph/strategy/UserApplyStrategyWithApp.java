...
/**
 * Get Stategy according to user's apply action with Application recommendation
 * @author zhangnan
 * @email zhangnan@renren-inc.com
 */
public class UserApplyStrategyWithApp implements Strategy {
...
//			CommonCategory friendCluster = new CommonCategory(CreateRecommendDataThread.FREINDS_CLUSTER, 13, 10);	
//			categoryList.add(friendCluster);
			
			CommonCategory commonFreinds = new CommonCategory(CreateRecommendDataThread.COMMON_FRIENDS, 26, 10);
			...
			CommonCategory video = new CommonCategory(CreateRecommendDataThread.RVIDEO, 5, 10);
			categoryList.add(video);
			
			CommonCategory blog = new CommonCategory(CreateRecommendDataThread.RBLOG, 5, 10);
...
//			categoryList.add(friendCluster);
			...
			CommonCategory commonFreinds = new CommonCategory(CreateRecommendDataThread.COMMON_FRIENDS, 30, 10);
			categoryList.add(commonFreinds);
