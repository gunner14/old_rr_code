...
service_start_class="com.renren.ad.sns.services.DeamonRunner";
...
case $service_name in
	"rabbitmq-service")
	service_bean_xml="src/main/resources/beans/rabbitmq-service.xml";
#	service_listen_port="9098";
	...
	"data-service")
	service_bean_xml="src/main/resources/beans/data-service-jmx.xml";
#	service_listen_port="9091";
	memory_options="-Xms512m -Xmx512m";
    gc_options=" -XX:+PrintGCApplicationStoppedTime -XX:+PrintGCDetails -XX:+PrintGCTimeStamps -XX:+PrintGCApplicationConcurrentTime -XX:+UseParNewGC -Xloggc:logs/gc.log";
	jmx_options="-Dcom.sun.management.jmxremote.port=8888 -Dcom.sun.management.jmxremote.password.file=/data/web/jmxremote.password.template/jmxremote.password -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.authenticate=false"
	service_vm_args="$jmx_options $memory_options $gc_options";
	;;
