...
import com.renren.ad.sns.services.uranus.SimilarityTagList2CandidatePickerTest.LinkComparator;

public class BasicTagList2CandidatePickerTest {
	...
	private BasicTagList2CandidatePicker picker = new BasicTagList2CandidatePicker();
	...
	public void testPick() {
		...
		List<Candidate> result = picker.pick(gid, tagList, tag2Candidate);
		assertEquals(result.size(), 5);
		assertEquals(result.get(0).getGid(), 1206011450014284178L);
	}
