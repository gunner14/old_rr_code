...
case $service_name in
	"uranus-service")
	service_bean_xml="src/main/resources/beans/uranus-service.xml";
	service_listen_port="9099";
	memory_options="-Xms4g -Xmx8g";
...
mvn exec:java -Dexec.mainClass="$service_start_class" -Dexec.args="$service_bean_xml server" >$stdout_file 2>$stderr_file &
