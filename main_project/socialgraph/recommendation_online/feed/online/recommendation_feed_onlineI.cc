...
RecommendItemSeq RecommendationFeedOnlineI::GetRecommendationByFeed(int userid, 
																																		int limit, 
																																		const Ice::Current& current) {
  std::ostringstream oss;
  oss << "[RecommendationFeedOnlineI] GetRecommendationByFeed userid:" << userid << " limit:" << limit;
	...
	return FeedRecommendBuilder::instance().GetRecommendData(userid, limit);
}
