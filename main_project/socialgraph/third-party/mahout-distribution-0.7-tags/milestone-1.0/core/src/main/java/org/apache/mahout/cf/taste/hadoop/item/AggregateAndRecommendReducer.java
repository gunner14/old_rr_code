...
public final class AggregateAndRecommendReducer extends
  ...
  private FastIDSet itemsToRecommendFor = null;
  private OpenIntLongHashMap indexItemIDMap = null;
  ...
  private void reduceNonBooleanData(VarLongWritable userID,
    ...
    while (iterator.hasNext()) {
      ...
      /* preference estimations must be based on at least 2 data points */
