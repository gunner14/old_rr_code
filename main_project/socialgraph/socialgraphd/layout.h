...
static const std::string PAGECOLLEGE = "PAGECOLLEGE";
...
static const std::string RCDSM = "RCDSM";
...
class PhotoFriendLayout : public Layout {
 public:
  PhotoFriendLayout(int uid, const RecommendItem& item_data):host_(uid), item_data_(item_data) {
  }
  virtual ~PhotoFriendLayout() {}

  const std::string getBizType() {
    return std::string("PhotoFriendLayout");
  }
...
//----------------------------------------------------------------------------------------------------------
/* @brief 为shopmaster首页推荐提供展示 */
class RcdShoppingMasterLayout : public Layout {
  public:
  RcdShoppingMasterLayout(int uid, const Item& item_data):host_(uid), item_data_(item_data) {

 }

  const std::string getBizType() {
    return std::string("RcdShoppingMasterLayout");
  }
  virtual ~RcdShoppingMasterLayout() {}
