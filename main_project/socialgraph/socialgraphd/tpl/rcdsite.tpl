...
<li class="clearfix" id="commonFriend_{{ID}}" onmouseover="Sizzle('a.shut-new',this)[0].style.display='block'" onmouseout="Sizzle('a.shut-new',this)[0].style.display='none'">
        ...
        <span class="headpichold">
                <a href="{{URL}}" onclick="logRcd({action:'frtPage_recommend_S_imgToPrf',guest_id:{{ID}},type:'{{TYPE_VALUE}}'})">
                        <img src="{{TINY_URL}}" width="50" height="50" />
                </a>
        </span>
        <span>
                <a class="name" href="{{URL}}" onclick="logRcd({action:'frtPage_recommend_S_nameToPrf',guest_id:{{ID}},type:'{{TYPE_VALUE}}'})">{{NAME}} <img src="http://a.xnimg.cn/imgpro/icons/site.png" /></a>
                <p>
