 ...
 * friends relation time among them), static weight and active weight among the host, friend, friends
 * of friends from extend friends of friends sequence file, compute them and then store ranking 
 * result to HBase 
