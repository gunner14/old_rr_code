...
import com.renren.xce.socialgraph.data.RcdFoFUtilGroupProbability;
import com.renren.xce.socialgraph.data.RcdFoFUtilGroupRotate;
...
//		}
		...
		if (FoFUpdator.kFoFProbabilityStrategy) {
			fofList = RcdFoFUtilGroupProbability.getInstance().getRcdFoFData(hostId, FoFUpdator.kFoFMaxLoadNumber);
		} else {
			fofList = RcdFoFUtilGroupRotate.getInstance().getRcdFoFData(hostId, FoFUpdator.kFoFMaxLoadNumber);
		}
