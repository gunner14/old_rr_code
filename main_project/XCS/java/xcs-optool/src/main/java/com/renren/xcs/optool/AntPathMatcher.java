...
public class AntPathMatcher {
    ...
    /**
     * Set the path separator to use for pattern parsing. Default is "/",
     * as in Ant.
     */
     ...
     *        pattern match as far as the given base path goes is
     *        sufficient)
     ...
     * 
     * @param pattern pattern to match against. Must not be
     *        <code>null</code>.
     * @param str string which must be matched against the pattern. Must
     ...
     * <code>/docs/cvs/commit.html</code> -> '<code>cvs/commit.html</code>'
     * </li>
