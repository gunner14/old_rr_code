...
#error No exception mode cannot be used with XPath support
#endif
...
#ifndef PUGIXML_NO_STL
	void xml_node::print(std::ostream& os, const char* indent, unsigned int flags, unsigned int depth) const
	{
		if (empty()) return;
