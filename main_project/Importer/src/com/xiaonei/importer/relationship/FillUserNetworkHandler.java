...
public class FillUserNetworkHandler implements ResultSetHandler {
	private static org.apache.commons.logging.Log _logger = org.apache.commons.logging.LogFactory
	.getLog(FillUserNetworkHandler.class);
private BuddyList _buddy;
private Map<Integer, String> _id2key;

public FillUserNetworkHandler(BuddyList buddy, Map<Integer, String> id2key) {
_buddy = buddy;
_id2key = id2key;
}
...
//					1, "USER");
		...
		buddy.currentNetworkId = currentNetworkId;
		buddy.currentNetworkStage = currentNetworkStage;
		buddy.currentNetworkName = currentNetworkName;
