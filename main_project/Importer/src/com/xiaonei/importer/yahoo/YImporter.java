...
public class YImporter implements WorkerCallback {
	
	private static YImporter instance = new YImporter();
	public static YImporter getInstance() {
		return instance;
	}
	private YImporter() {
	}
	...
	public void requestBuddyList(OwnerInfo owner) {
		...
		TaskManager.getInstance().addTask(new YWorker(owner.email, owner.password, requestId, this));
	}
