...
using namespace Ice;
using std::set;
const Ice::Int USER_POOL_SIZE = 20023;
//const Ice::Int USER_POOL_SIZE = 6133;
//const Ice::Int USER_POOL_SIZE = 1933;
//const Ice::Int USER_POOL_SIZE = 9973;
...
public:
  ...
  //virtual NotifyIndexSeq GetRemindMessage(int uid, int begin, int limit, const Ice::Current& = Ice::Current());
  ...
  virtual void ProcessMessageById(int uid, Ice::Long nid, int type, int bigtype, const Ice::Current& = Ice::Current());
  virtual void ProcessMessageByIds(int uid, const MyUtil::LongSeq& nids, int type, int bigtype, const Ice::Current& = Ice::Current()); 
  virtual void ReadAllMessageByBigtype(int uid, int bigtype, const Ice::Current& = Ice::Current());
  ...
  virtual void RemoveRMessageByBigtype(int uid, int bigtype, const Ice::Current& = Ice::Current());
  virtual void RemoveRepeatedRMsgByBigtype(int uid, int bigtype, const Ice::Current& = Ice::Current());
  ...
  //================RMESSAGE====================
  // temporary interface for renren desktop
  virtual int GetBigTypeById(int userId, Ice::Long notifyId, const Ice::Current& = Ice::Current());
  virtual void RemoveRMessageByIdNoType(int userId, Ice::Long notifyId, const Ice::Current& = Ice::Current());
...
private:
  ...
  UserMessagePoolPtr GetRMessagePool(int userid){
    if (userid > 0) {
      UserMessagePoolPtr user_pool_ptr = _user_rmessage_pool[userid % USER_POOL_SIZE];
      return user_pool_ptr;
    } else {
      MCE_WARN("NotifyIndexManagerN::GetRMessagePool userid ["
          << userid << "] less than 0");
      return 0;
    }
  }
