{{#LI_SEC}}
  <li class="request">
    ...
    <div class="btns">
      <button click="xiaozhan_accept:{{siteUrl}},{{hostId}},{{nid}}">接受</button>
      <button click="xiaozhan_refuse:{{siteUrl}},{{hostId}},{{nid}}" class="gray-btn">拒绝</button>
    </div>
    <div class="btn-x">
            <a class="x-to-delete" click="xiaozhan_xxx:{{siteUrl}},{{hostId}},{{nid}}"></a>
    </div>
