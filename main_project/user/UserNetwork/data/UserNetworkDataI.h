...
class NetworkDataI : public NetworkData 
{
    ...
    ::xce::binstring::BinStringPtr serialize() const
	{
		...
		for(NetworkSeq::const_iterator it = networks.begin();
                it != networks.end(); ++it) {
            binString->add((*it)->id);
        ...
        for(HighSchoolInfoSeq::const_iterator it = highschools.begin();
                it != highschools.end(); ++it) {
            binString->add((*it)->id);
        ...
        for(UniversityInfoSeq::const_iterator it = universities.begin();
                it != universities.end(); ++it) {
            binString->add((*it)->id);
        ...
        for(WorkspaceInfoSeq::const_iterator it = workspaces.begin();
        ...
        for(CollegeInfoSeq::const_iterator it = colleges.begin();
                it != colleges.end(); ++it) {
            binString->add((*it)->id);
        ...
        for(ElementarySchoolInfoSeq::const_iterator it = elementaries.begin();
                it != elementaries.end(); ++it) {
        ...
        for(JuniorHighSchoolInfoSeq::const_iterator it = juniorhighschools.begin();
                it != juniorhighschools.end(); ++it) {
        ...
        for(RegionInfoSeq::const_iterator it = regions.begin();
                it != regions.end(); ++it) {
            binString->add((*it)->id);
