#include "UserContactPreloader.h"
...
void MyUtil::initialize() {
	...
	string ctlEndpoint = ServiceI::instance().getCommunicator()->getProperties()->getPropertyWithDefault("UserDesc.Controller", "ControllerUserDesc");
        ...
        int timeout = ServiceI::instance().getCommunicator()->getProperties()->getPropertyAsIntWithDefault("UserDesc.Proxy.Timeout", 300);
	
		int cluster = 100;
		
		GeneralPreloader<UserContactManagerPrx>::instance().initialize(
