...
public:
  ...
  //a function which used to reload white list from table passport_control
  virtual void reloadWhiteList(const string& userName, const string& password, const Ice::Current& = Ice::Current()) {}
  virtual void setWhitelistEnable(const string& userName, const string& password, bool enable, const Ice::Current& = Ice::Current()) {}
  virtual bool getWhitelistEnable(const Ice::Current& = Ice::Current()) { return false; }
...
public:
	...
	virtual bool isValid(const ::Ice::Current& = ::Ice::Current());
  virtual void setValidForce(bool, const Ice::Current& = ::Ice::Current());
private:
...
public:
	...
	void setValid(bool valid);
  virtual void setValidForce(bool, const Ice::Current&);
private:
