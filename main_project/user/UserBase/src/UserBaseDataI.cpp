...
void UserBornDataI::parse(const UserBasicDataIPtr& obj)
{
	id = obj->id ;
	gender = obj->gender ;
	...
	homeProvince = obj->homeProvince ;
	homeCity = obj->homeCity ;
	cityCode = obj->cityCode ;
	astrology = obj->astrology ;
}

void UserBornDataI::parse(Ice::ObjectPtr& obj)
{
	UserBornDataPtr data = UserBornDataPtr::dynamicCast(obj);
	id = data->id ;
	gender = data->gender ;
	birthDay = data->birthDay ;
	birthMonth = data->birthMonth ;
