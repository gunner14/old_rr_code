...
public:
    ...
    virtual UserStateDataNPtr getUserStateN(Ice::Int userId, const Ice::Current& = Ice::Current());
...
public:
	...
	virtual UserUrlDataNPtr getUserUrlN(Ice::Int userId, const Ice::Current& = Ice::Current());
...
private:
	...
	void parseData(UserBasicDataIPtr& desData, const UserBornDataIPtr& bornData, 
...
public:
    ...
    virtual UserBaseViewDataPtr getUserBaseView( Ice::Int userId,
                                        	  const Ice::Current& = Ice::Current());
    virtual UserBaseViewData3Ptr getUserBaseView3( Ice::Int userId,
                                        	  const Ice::Current& = Ice::Current());
	virtual UserCommonViewDataPtr getUserCommonView(int userId, 
			                                  const Ice::Current& = Ice::Current());
	virtual UserCommonViewDataNPtr getUserCommonViewN(int userId, 
			                                  const Ice::Current& = Ice::Current());
	...
	void setValidForce(bool valid, const Ice::Current& = Ice::Current());
private:
  UserBaseViewDataIPtr m_getUserBaseView(int userId,
                                        	  const Ice::Current& = Ice::Current());
	UserCommonViewDataIPtr m_getUserCommonView(int userId,
                                        	  const Ice::Current& = Ice::Current());
