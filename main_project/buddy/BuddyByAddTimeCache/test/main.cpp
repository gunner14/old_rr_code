...
int main(int argc, char* argv[]) {
	for( int i=24496250;i<24496260;++i ){
		cout << i << " - " << BuddyByAddTimeCacheAdapter::instance().getFriendList(i,-1).size() << endl;
	}
/*
	MyUtil::IntSeq ids;
	ids.push_back(316932644);
	ids.push_back(68126);
	BuddyByAddTimeLoaderAdapter::instance().ignoreOffers(24496255,ids);
*/
