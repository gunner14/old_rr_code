...
def make_map(config):
    ...
    map.connect('/view-logs', controller='FeedAdmin', action='ViewLogs')
    ...
    map.connect('/whitelist-view', controller='FeedAdmin', action='WhiteListView')
    map.connect('/add-white-id', controller='FeedAdmin', action='AddWhiteId')
    map.connect('/del-whiteid', controller='FeedAdmin', action='DelWhiteId')
    map.connect('/get-whitelist', controller='FeedAdmin', action='GetWhiteList')
    ...
    #TimelineFeed FeedMini FeedNews config
    map.connect('/timelinefeed.do',controller='FeedAdmin',action='TimeLineFeedDo')
    map.connect('/feedmini.do',controller='FeedAdmin',action='FeedMiniDo')
    map.connect('/feednews.do',controller='FeedAdmin',action='FeedNewsDo')
    map.connect('/draw.do',controller='FeedAdmin',action='DrawDo')
