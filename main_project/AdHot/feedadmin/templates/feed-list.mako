...
<div class="admin-only hidden">
  <table width="1200" border="1" class="t1">
    <tr>
      <th align="left"><a href="/feed-config-create">新建新鲜事类型</a> &nbsp; <a href="/user-apply-list">处理申请</a> &nbsp; <a class="reloadtest" href="#nogo">测试环境重新加载</a> &nbsp;<a href="/view-logs?stype=reloadlog" target="_blank">查看谁在重载</a> &nbsp;<a href="/view-logs?stype=whitelist" target="_blank">查看白名单log</a>&nbsp; <a class="reloaddist hidden" href="#nogo">线上环境重新加载</a></th>
    </tr>
  </table>
</div>
<div class="user-only hidden">
  <table width="1200" border="1" class="t1">
    <tr>
      <th align="left"><a target="_blank" href="/user-apply">申请新鲜事创建及修改</a>&nbsp;HI,遇到任何问题请联系QQ:844244943,Email:tinghai.zhang@renren-inc.com</th>
    </tr>
  </table>
</div>
<br/>
...
$('a.reloadtest').click(
  function() {
    $.ajax('/reloadtest?stype=0&version=0', {
