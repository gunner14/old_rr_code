...
def make_map(config):
    ...
    map.connect('/save-stype-keys', controller='hello', action='SaveStypeKeys')
    # map.connect('/validate-tpl', controller='hello', action='ValidateTemplate')
    # map.connect('/save-tpl', controller='hello', action='SaveTemplate')
    # map.connect('/remove-tpl', controller='hello', action='RemoveTemplate')
    map.connect('/get-stype-tree', controller='hello', action='GetStypeTree')
    map.connect('/get-stype-keys', controller='hello', action='GetStypeKeys')
    # map.connect('/get-stype-versions', controller='hello', action='GetStypeVersions')
    map.connect('/get-stype-tpls', controller='hello', action='GetStypeTpls')
    ...
    map.connect('/generate-code', controller='FeedAdmin', action='GenreateCode')
