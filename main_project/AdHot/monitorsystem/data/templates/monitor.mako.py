...
_magic_number = 6
_modified_time = 1308030241.4340329
_template_filename='/data/xce/pylons/monitorsystem/monitorsystem/templates/monitor.mako'
_template_uri='/monitor.mako'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        # SOURCE LINE 122
        __M_writer(u'\n\n\t\t</select>\n\n\t\t<table style="margin-top:10px">\n\t\t\t<tr>\n\t\t\t\t\t<th>\u65f6\u95f4\u6bb5:<th>\n    \t\t\t\t<th><a href="http://10.3.19.120:5000/monitor/')
        # SOURCE LINE 129
        __M_writer(escape(c.chartname))
        ...
        for imginfo in c.photo_list:
                
                link = "<a title=\"Zoom Out\" href=" + "\""+ imginfo.big_photo_url+ "\"" +">"
        ...
        __M_locals_builtin_stored = __M_locals_builtin()
        __M_locals.update(__M_dict_builtin([(__M_key, __M_locals_builtin_stored[__M_key]) for __M_key in ['ImageInfo','g','i','content','link','origin_imglink','base_top','imginfo'] if __M_key in __M_locals_builtin_stored]))
        # SOURCE LINE 167
        __M_writer(u'\t\n\t</div>\n\n\n\n\n\t<div id="linkList">\n\t\t<div id="linkList2">\n\t\t\t<p >\u4e0b\u9762\u7684\u670d\u52a1\u51fa\u95ee\u9898\u5566!!!</p>\n\t\t\t')
        # SOURCE LINE 176
