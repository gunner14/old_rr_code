...
<div id="container">
	...
	<div id="pageHeader">
		...
		<table style="margin-top:10px">
			<tr>
					<th>时间段:<th>
    				<th><a href="http://10.3.19.120:5000/monitor/${c.chartname}/60">1H</a></th>
    				<th><a href="http://10.3.19.120:5000/monitor/${c.chartname}/180">3H</a></th>
    				<th><a href="http://10.3.19.120:5000/monitor/${c.chartname}/360">6H</a></th>
    				<th><a href="http://10.3.19.120:5000/monitor/${c.chartname}/720">12H</a></th>
    				<th><a href="http://10.3.19.120:5000/monitor/${c.chartname}/1440">1D</a></th>
    				<th><a href="http://10.3.19.120:5000/monitor/${c.chartname}/10080">1W</a></th>
			</tr>
		</table>
	...
	<div id="imgRegion">
		<p  style="font-size:150%; color:blue; margin-left:10px">${c.description}</p>
		<%
