...
class TripodClient {
 ...
 public:
  ...
  void GetHash(const std::string& key, const StrList& fields, HashPair& value);
  void GetMissedHash(const std::string& key, const StrList& fields, HashPair& value, bool use_master = true);
  bool LoadListCache(const std::string& key, bool use_master = true, const long timeout = 5000);
  bool LoadHashCache(const std::string& key, bool use_master = true, const long timeout = 5000);
