package com.xiaonei.xce.test.dbcachenotifyconfig;
...
public class DbCacheNotifyConfigTestCase{
	private static DbCacheNotifyConfigAdapter _adapter;
	private int _userid;
	private int _fieldSize;
	private String _field1;
	private String _field2;
	private int _rowSize;
	public DbCacheNotifyConfigTestCase(int userid, int fieldSize, String field1, String field2, int rowSize){
		this._userid = userid;
	...
	public static void setUpBeforeClass() throws Exception {
		_adapter = DbCacheNotifyConfigAdapter.getInstance();
	}
	@AfterClass
